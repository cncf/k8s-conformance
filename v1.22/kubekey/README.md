...
spec:
  ...
  - {name: node2, address: 192.168.0.3, internalAddress: 192.168.0.3, user: root, password: Qcloud@123}
  - {name: node3, address: 192.168.0.2, internalAddress: 192.168.0.2, user: root, password: Qcloud@123}
  roleGroups:
    etcd:
    - node1
    - node2
