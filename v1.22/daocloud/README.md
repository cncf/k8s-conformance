...
First install DaoCloud Enterprise 4.0.7, which is based on Kubernetes 1.22.0. To install DaoCloud Enterprise, run the following commands on CentOS 7.7 System:
```
sudo su
curl -L https://dce.daocloud.io/DaoCloud_Enterprise/4.0.7os-requirements  > ./os-requirements
chmod +x ./os-requirements
./os-requirements
bash -c "$(docker run -i --rm daocloud.io/daocloud/dce:4.0.7-35143 install)"
```
