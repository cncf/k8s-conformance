...
**NOTE**: These steps are a reproduction of our QEMU docs at https://www.talos.dev/docs/v0.12/local-platforms/qemu.
...
```bash
curl https://github.com/talos-systems/talos/releases/download/v0.12.0/talosctl-linux-amd64 -L -o talosctl
