...
curl -L -o acs-engine-darwin.zip https://github.com/Azure/acs-engine/releases/download/v0.8.0/acs-engine-v0.8.0-darwin-amd64.zip

# Get the Kubernetes 1.8 install json

curl -o kubernetes1.8.json https://raw.githubusercontent.com/Azure/acs-engine/master/examples/kubernetes-releases/kubernetes1.8.json
