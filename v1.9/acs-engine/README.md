...
# Get the Kubernetes 1.9 install json

curl -o kubernetes1.9.json https://raw.githubusercontent.com/Azure/acs-engine/master/examples/kubernetes-releases/kubernetes1.9.json
...
$ acs-engine deploy --subscription-id $SUBID \
    ...
    --auto-suffix --api-model kubernetes1.9.json 
