...
curl -o kubernetes1.11.json https://raw.githubusercontent.com/Azure/aks-engine/patch-release-v0.36.2/examples/azurestack/kubernetes-azurestack-azure-ad.json
