...
Official documentation: https://docs.kubermatic.com/kubeone/v1.7/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.27
clusters, KubeOne v1.7.0 or newer is required.
