...
master_ip: 10.60.200.205

master_mode "no"
```
```
$ vi etc/hosts
10.60.200.205 acc-master
10.60.200.206 acc-worker1
10.60.200.207 acc-worker2
```
...
acc-master    Ready    control-plane   4d7h   v1.27.6   10.60.200.205   <none>        CentOS Linux 7 (Core)   3.10.0-957.el7.x86_64   containerd://1.6.24
acc-worker1   Ready    worker          4d7h   v1.27.6   10.60.200.206   <none>        CentOS Linux 7 (Core)   3.10.0-957.el7.x86_64   containerd://1.6.24
acc-worker2   Ready    worker          4d7h   v1.27.6   10.60.200.207   <none>        CentOS Linux 7 (Core)   3.10.0-957.el7.x86_64   containerd://1.6.24
```
