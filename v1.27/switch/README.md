...
4. Follow the wizard. Unless specified in the list below, go with the default or, if a selection/value is required but no default is provided, your own preferrence.
   - In step 2 ("Cluster"): choose "Control Plane Version" "1.27.10", and choose "iptables" as the "Proxy Mode" under "Advanced Network Configuration".
   - In step 4 ("Initial Nodes"): set "Replicas" to "2" (or more), "Flavor" to "c002r004" (or larger), and set "Disk Size in GB" to "10" (or larger).
