...
## plusserver Kubernetes Engine (PSKE)  (base on Kubernetes v1.28.5)
...
- Select the 1.28.5 version of Kubernetes
...
```sh
$ sonobuoy retrieve
202402071115_sonobuoy_71c13711-c579-4f77-ba1f-560d12dbe898.tar.gz
```
