...
$ ibmcloud ks cluster create classic --name conformance --version 1.28 --zone ZONE --flavor FLAVOR --private-vlan VLAN --public-vlan VLAN --workers COUNT

$ # Option 2: Create a cluster on Virtual Private Cloud (VPC) infrastructure.
$ ibmcloud ks cluster create vpc-gen2 --name conformance --version 1.28 --zone ZONE --flavor FLAVOR --vpc-id ID --subnet-id ID --workers COUNT
```
...
UI, select version 1.28.10 and choose either classic or VPC infrastructure. Then
