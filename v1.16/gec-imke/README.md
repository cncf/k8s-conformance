...
Please email sales@german-edge-cloud.io and ask for a new account credentials for Optimist and IMKE to be used by Cloud Native Computing Foundation (CNCF) Conformance tests for v1.16/innovo-imke 
...
If you have any issues please email support@gec.io
