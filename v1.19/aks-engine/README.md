...
```console
curl -L -o aks-engine-darwin.tar.gz https://github.com/Azure/aks-engine/releases/download/v0.56.0/aks-engine-v0.56.0-darwin-amd64.tar.gz
```

Download the Kubernetes 1.19 install cluster definition.

```console
curl -o kubernetes1.19.json https://raw.githubusercontent.com/Azure/aks-engine/master/examples/kubernetes-releases/kubernetes1.19.json
```
...
$ aks-engine deploy --subscription-id $SUBID \
    ...
    --auto-suffix --api-model kubernetes1.19.json
```
