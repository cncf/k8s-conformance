...
Download the k0s v0.7.0 binary from [releases](https://github.com/k0sproject/k0s/releases/v0.7.0) and push it to all the nodes you wish to connect to the cluster.
