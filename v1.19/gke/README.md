...
export CLUSTER_NAME=gke-1-19

export CONFORMANCE_VERSION=v1.19.7
export SONOBUOY_IMAGE_VERSION=v0.19.0
...
#
# At time of test (2021-02-12), the rapid channel was at 1.18 by default,
# so we specify the specific cluster version of 1.19.7-gke.800
#

gcloud --project $PROJECT_ID container clusters create $CLUSTER_NAME \
  --release-channel=rapid \
  --cluster-version=1.19.7-gke.800 \
  --enable-ip-alias \
