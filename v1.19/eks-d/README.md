...
wget -qO ./kops "https://github.com/kubernetes/kops/releases/download/v1.19.3/kops-${os_arch}"
chmod +x ./kops
```
...
export CNI_ASSET_HASH_STRING=sha256:7091deba76ba1d72adeaa928efd8026d5bf877a490a55667de26afe61ce9c23c
...
## Run Sonobuoy e2e
```
./sonobuoy run --mode=certified-conformance --wait --kube-conformance-image k8s.gcr.io/conformance:v1.19.8
