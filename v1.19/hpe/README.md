...
### Create 1.19.5 Kubernetes cluster
...
-Choose the k8s version as '1.19.5'.
-Click 'Submit' button.
...
-mkdir /root/bin
-VERSION=0.19.0 OS=linux && curl -L "https://github.com/vmware-tanzu/sonobuoy/releases/download/v${VERSION}/sonobuoy_${VERSION}_${OS}_amd64.tar.gz" --output $HOME/bin/sonobuoy.tar.gz && tar -xzf $HOME/bin/sonobuoy.tar.gz -C $HOME/bin && chmod +x $HOME/bin/sonobuoy && rm $HOME/bin/sonobuoy.tar.gz
- sonobuoy run 
