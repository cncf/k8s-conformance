# Kubernetes Conformance Test Suite -  1.19
...
## [Container Runtime, TerminationMessage, from log output of succeeding container](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/runtime.go#L237)
...
## [Container Runtime, Restart Policy, Pod Phases](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/runtime.go#L49)
...
## [Kubelet, hostAliases](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/kubelet.go#L146)
...
## [Environment variables, expansion](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/expansion.go#L41)
...
## [VolumeSubpathEnvExpansion, subpath with backticks](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/expansion.go#L149)
...
## [Admission webhook, ordered mutation](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/webhook.go#L249)
...
## [Custom Resource Definition Conversion Webhook, conversion custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/crd_conversion_webhook.go#L147)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields at root](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/crd_publish_openapi.go#L181)
...
## [Custom Resource OpenAPI Publish, varying groups](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/crd_publish_openapi.go#L263)
...
## [Event resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/events.go#L48)
...
## [ResourceQuota, object count quota, service](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apimachinery/resource_quota.go#L85)
...
## [Deployment Proportional Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apps/deployment.go#L134)
...
## [Replica Set, adopt matching pods and release non matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apps/replica_set.go#L114)
...
## [StatefulSet resource Replica scaling](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/apps/statefulset.go#L839)
...
## [Service account tokens auto mount optionally](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/auth/service_accounts.go#L281)
...
## [Kubectl, create service, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/kubectl/kubectl.go#L1252)
...
## [Kubectl, replace](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/kubectl/kubectl.go#L1595)
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/networking.go#L81)
...
## [Service, change type, ExternalName to ClusterIP](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L1693)
...
## [Service, ClusterIP type, session affinity to None](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2490)
...
## [Find Kubernetes Service in default Namespace](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2805)
...
## [Service, NodePort type, session affinity to ClientIP with timeout](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2522)
...
## [Service, ClusterIP type, session affinity to ClientIP with timeout](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2474)
...
## [Service, NodePort type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2505)
...
## [Service, ClusterIP type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2458)
...
## [Kubernetes Service](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L805)
...
## [Service, endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L815)
...
## [Service, endpoints with multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L868)
...
## [Endpoint resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/network/service.go#L2828)
...
## [ConfigMap, from environment field](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap.go#L42)
...
## [ConfigMap, from environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap.go#L90)
...
## [ConfigMap, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap.go#L135)
...
## [ConfigMap lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap.go#L166)
...
## [DownwardAPI, environment for CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downward_api.go#L164)
...
## [DownwardAPI, environment for default CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downward_api.go#L215)
...
## [DownwardAPI, environment for host ip](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downward_api.go#L88)
...
## [DownwardAPI, environment for Pod UID](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downward_api.go#L265)
...
## [DownwardAPI, environment for name, namespace and ip](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downward_api.go#L42)
...
## [PodTemplate, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/podtemplates.go#L118)
...
## [PodTemplate lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/podtemplates.go#L49)
...
## [LimitRange, resources](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/limit_range.go#L55)
...
## [Scheduler, resource limits](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/predicates.go#L322)
...
## [Scheduler, node selector matching](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/predicates.go#L455)
...
## [Scheduler, node selector not matching](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/predicates.go#L432)
...
## [Scheduling, HostPort and Protocol match, HostIPs different but one is default HostIP (0.0.0.0)](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/predicates.go#L693)
...
## [Scheduling, HostPort matching and HostIP and Protocol not-matching](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/predicates.go#L660)
...
## [Pod preemption verification](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/preemption.go#L533)
...
## [Scheduler, Basic Preemption](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/preemption.go#L120)
...
## [Scheduler, Preemption for critical pod](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/scheduling/preemption.go#L208)
...
## [ConfigMap Volume, text data, binary data](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L204)
...
## [ConfigMap Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L300)
...
## [ConfigMap Volume, without mapping](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L44)
...
## [ConfigMap Volume, without mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L71)
...
## [ConfigMap Volume, without mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L54)
...
## [ConfigMap Volume, with mapping](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L86)
...
## [ConfigMap Volume, with mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L96)
...
## [ConfigMap Volume, with mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L106)
...
## [ConfigMap Volume, multiple volume maps](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L483)
...
## [ConfigMap Volume, update](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/configmap_volume.go#L121)
...
## [DownwardAPI volume, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L194)
...
## [DownwardAPI volume, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L222)
...
## [DownwardAPI volume, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L208)
...
## [DownwardAPI volume, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L236)
...
## [DownwardAPI volume, CPU limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L250)
...
## [DownwardAPI volume, memory limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L262)
...
## [DownwardAPI volume, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L51)
...
## [DownwardAPI volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L66)
...
## [DownwardAPI volume, file mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L82)
...
## [DownwardAPI volume, update annotations](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L160)
...
## [DownwardAPI volume, update label](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/downwardapi_volume.go#L128)
...
## [EmptyDir, Shared volumes between containers](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L223)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L193)
...
## [EmptyDir, medium memory, volume mode 0644, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L123)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L203)
...
## [EmptyDir, medium memory, volume mode 0666,, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L133)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L213)
...
## [EmptyDir, medium memory, volume mode 0777, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L143)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L163)
...
## [EmptyDir, medium memory, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L93)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L173)
...
## [EmptyDir, medium memory, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L103)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L183)
...
## [EmptyDir, medium memory, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L113)
...
## [EmptyDir, medium default, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L153)
...
## [EmptyDir, medium memory, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/empty_dir.go#L83)
...
## [EmptyDir Wrapper Volume, ConfigMap volumes, no race](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/empty_dir_wrapper.go#L187)
...
## [EmptyDir Wrapper Volume, Secret and ConfigMap volumes, no conflict](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/empty_dir_wrapper.go#L65)
...
## [Projected Volume, multiple projections](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_combined.go#L41)
...
## [Projected Volume, ConfigMap, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L209)
...
## [Projected Volume, ConfigMap, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L44)
...
## [Projected Volume, ConfigMap, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L71)
...
## [Projected Volume, ConfigMap, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L54)
...
## [Projected Volume, ConfigMap, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L86)
...
## [Projected Volume, ConfigMap, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L96)
...
## [Projected Volume, ConfigMap, mapped, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L106)
...
## [Projected Volume, ConfigMap, multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L410)
...
## [Projected Volume, ConfigMap, update](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_configmap.go#L121)
...
## [Projected Volume, DownwardAPI, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L194)
...
## [Projected Volume, DownwardAPI, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L222)
...
## [Projected Volume, DownwardAPI, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L208)
...
## [Projected Volume, DownwardAPI, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L236)
...
## [Projected Volume, DownwardAPI, CPU limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L250)
...
## [Projected Volume, DownwardAPI, memory limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L262)
...
## [Projected Volume, DownwardAPI, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L51)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L66)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L82)
...
## [Projected Volume, DownwardAPI, update annotation](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L160)
...
## [Projected Volume, DownwardAPI, update labels](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_downwardapi.go#L128)
...
## [Projected Volume, Secrets, create, update delete](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L212)
...
## [Projected Volume, Secrets, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L43)
...
## [Project Volume, Secrets, non-root, custom fsGroup](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L64)
...
## [Projected Volume, Secrets, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L53)
...
## [Projected Volume, Secrets, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L75)
...
## [Projected Volume, Secrets, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L85)
...
## [Projected Volume, Secrets, mapped, multiple paths](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/projected_secret.go#L116)
...
## [Secrets Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L202)
...
## [Secrets Volume, volume mode default, secret with same name in different namespace](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L96)
...
## [Secrets Volume, default](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L44)
...
## [Secrets Volume, volume mode 0440, fsGroup 1001 and uid 1000](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L65)
...
## [Secrets Volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L54)
...
## [Secrets Volume, mapping](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L76)
...
## [Secrets Volume, mapping, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L86)
...
## [Secrets Volume, mapping multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/common/secrets_volume.go#L122)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/subpath.go#L71)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/subpath.go#L83)
...
## [SubPath: Reading content from a downwardAPI volume.](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/subpath.go#L97)
...
## [SubPath: Reading content from a projected volume.](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/subpath.go#L113)
...
## [SubPath: Reading content from a secret volume.](https://github.com/kubernetes/kubernetes/tree/release-1.19/test/e2e/storage/subpath.go#L59)
