# Kubernetes Conformance Test Suite -  v1.16
...
## [Service endpoint latency, thresholds](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/network/service_latency.go#L55)
...
## [Pod events, verify event from Scheduler and Kubelet](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/node/events.go#L43)
...
## [Pods, delete grace period](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/node/pods.go#L56)
...
## [Pods, QOS](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/node/pods.go#L188)
...
## [Pods, prestop hook](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/node/pre_stop.go#L182)
...
## [Scheduler, resource limits](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/predicates.go#L249)
...
## [Scheduler, node selector not matching](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/predicates.go#L356)
...
## [Scheduler, node selector matching](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/predicates.go#L379)
...
## [Scheduling, HostPort matching and HostIP and Protocol not-matching](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/predicates.go#L584)
...
## [Scheduling, HostPort and Protocol match, HostIPs different but one is default HostIP (0.0.0.0)](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/predicates.go#L617)
...
## [Taint, Pod Eviction on taint removal](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/taints.go#L287)
...
## [Pod Eviction, Toleration limits](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/scheduling/taints.go#L417)
...
## [EmptyDir Wrapper Volume, Secret and ConfigMap volumes, no conflict](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/empty_dir_wrapper.go#L65)
...
## [EmptyDir Wrapper Volume, ConfigMap volumes, no race](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/empty_dir_wrapper.go#L186)
...
## [SubPath: Reading content from a secret volume.](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/subpath.go#L59)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/subpath.go#L70)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/subpath.go#L81)
...
## [SubPath: Reading content from a downwardAPI volume.](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/subpath.go#L94)
...
## [SubPath: Reading content from a projected volume.](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e/storage/subpath.go#L109)
...
## [Pod liveness probe, using local file, delayed by startup probe](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e_node/startup_probe_test.go#L62)

### Release v1.16
A Pod is created with liveness probe that uses ‘exec’ command to cat the non-existent /tmp/health file. Liveness probe MUST NOT fail until startup probe expires.



## [Pod liveness probe, using local file, delayed by startup probe](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e_node/startup_probe_test.go#L91)

### Release v1.16
A Pod is created with liveness probe that uses ‘exec’ command to cat the non-existent /tmp/health file. Liveness probe MUST fail after startup probe expires. The Pod MUST now be killed and restarted incrementing restart count to 1.



## [Pod liveness probe, using local file, startup finished restart](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e_node/startup_probe_test.go#L120)

### Release v1.16
A Pod is created with liveness probe that uses ‘exec’ command to cat /temp/health file. The Container is started by creating /tmp/startup after 10 seconds, triggering liveness probe to fail. The Pod MUST now be killed and restarted incrementing restart count to 1.



## [Pod readiness probe, delayed by startup probe](https://github.com/kubernetes/kubernetes/tree/v1.16.0/test/e2e_node/startup_probe_test.go#L149)
...
Total Conformance Tests: 280, total legacy tests that need conversion: 0, while total tests that need comment sections: 0
