# Kubernetes Conformance Test Suite -  1.37
...
## **List of Tests**
## [Priority and Fairness FlowSchema API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/flowcontrol.go#L272)
...
## [Priority and Fairness PriorityLevelConfiguration API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/flowcontrol.go#L518)
...
## [Admission webhook, list mutating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L719)
...
## [Admission webhook, list validating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L645)
...
## [Admission webhook, update mutating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L568)
...
## [Admission webhook, update validating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L473)
...
## [Mutating Admission webhook, create and update mutating webhook configuration with matchConditions](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L842)
...
## [Validating Admission webhook, create and update validating webhook configuration with matchConditions](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L788)
...
## [Admission webhook, deny attach](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L209)
...
## [Admission webhook, deny custom resource create and delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L220)
...
## [Admission webhook, deny create](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L198)
...
## [Admission webhook, deny custom resource definition](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L300)
...
## [Admission webhook, honor timeout](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L370)
...
## [Admission webhook, discovery document](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L118)
...
## [Admission webhook, ordered mutation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L249)
...
## [Admission webhook, mutate custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L284)
...
## [Admission webhook, mutate custom resource with different stored version](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L314)
...
## [Admission webhook, mutate custom resource with pruning](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L331)
...
## [Mutating Admission webhook, mutating webhook excluding object with specific name](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L945)
...
## [Admission webhook, mutation with defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L260)
...
## [Admission webhook, admission control not allowed on webhook configuration objects](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L272)
...
## [Mutating Admission webhook, reject mutating webhook configurations with invalid matchConditions](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L920)
...
## [Validing Admission webhook, reject validating webhook configurations with invalid matchConditions](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L896)
...
## [Admission webhook, fail closed](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/webhook.go#L237)
...
## [Aggregated Discovery Interface](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/aggregated_discovery.go#L259)
...
## [Aggregated Discovery Interface CRDs](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/aggregated_discovery.go#L303)
...
## [Aggregated Discovery Endpoint Accept Headers](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/aggregated_discovery.go#L151)
...
## [Aggregated Discovery Endpoint Accept Headers CRDs](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/aggregated_discovery.go#L194)
...
## [aggregator-supports-the-sample-apiserver](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/aggregator.go#L102)

- Added to conformance in release v1.17, v1.21, v1.27
- Defined in code as: [sig-api-machinery] Aggregator Should be able to support the 1.17 Sample API Server using the current Aggregator [LinuxOnly] [Conformance]

Ensure that the sample-apiserver code from 1.17 and compiled against 1.17 will work on the current Aggregator/API-Server. This test is marked LinuxOnly because etcd does not provide or support images for Windows.

## [Custom Resource Definition Conversion Webhook, convert mixed version list](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_conversion_webhook.go#L175)
...
## [Custom Resource Definition Conversion Webhook, conversion custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_conversion_webhook.go#L140)
...
## [Custom Resource Definition, watch](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_watch.go#L52)
...
## [Custom Resource Definition, create](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/custom_resource_definition.go#L61)
...
## [Custom Resource Definition, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/custom_resource_definition.go#L148)
...
## [Custom Resource Definition, list](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/custom_resource_definition.go#L88)
...
## [Custom Resource Definition, defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/custom_resource_definition.go#L272)
...
## [Custom Resource Definition, discovery](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/custom_resource_definition.go#L201)
...
## [custom-resource-definition-field-selectors-list-watch-register-informers](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_selectable_fields.go#L124)
...
## [Custom Resource OpenAPI Publish, stop serving version](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L447)
...
## [Custom Resource OpenAPI Publish, version rename](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L396)
...
## [Custom Resource OpenAPI Publish, with x-kubernetes-preserve-unknown-fields at root](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L199)
...
## [Custom Resource OpenAPI Publish, with x-kubernetes-preserve-unknown-fields in embedded object](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L241)
...
## [Custom Resource OpenAPI Publish, with validation schema](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L74)
...
## [Custom Resource OpenAPI Publish, with x-kubernetes-preserve-unknown-fields in object](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L158)
...
## [Custom Resource OpenAPI Publish, varying groups](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L281)
...
## [Custom Resource OpenAPI Publish, varying kinds](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L362)
...
## [Custom Resource OpenAPI Publish, varying versions](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/crd_publish_openapi.go#L314)
...
## [Discovery, confirm the groupVerion and a resourcefrom each apiGroup](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/discovery.go#L172)
...
## [Discovery, confirm the PreferredVersion for each api group](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/discovery.go#L126)
...
## [Server side field validation, unknown fields CR no validation schema](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L287)
...
## [Server side field validation, valid CR with validation schema](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L166)
...
## [Server side field validation, unknown fields CR fails validation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L348)
...
## [Server side field validation, CR duplicates](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L620)
...
## [Server side field validation, typed object](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L62)
...
## [Server side field validation, unknown metadata](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L472)
...
## [Server side field validation, typed unknown metadata](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/field_validation.go#L115)
...
## [Garbage Collector, delete deployment,  propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L488)
...
## [Garbage Collector, delete replication controller, propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L330)
...
## [Garbage Collector, delete replication controller, after owned pods](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L647)

- Added to conformance in release v1.9
- Defined in code as: [sig-api-machinery] Garbage collector should keep the rc around until all its pods are deleted if the deleteOptions says so [Conformance] [Serial]
...
## [Garbage Collector, dependency cycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L826)
...
## [Garbage Collector, multiple owners](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L722)

- Added to conformance in release v1.9
- Defined in code as: [sig-api-machinery] Garbage collector should not delete dependents that have both valid owner and owner that's waiting for dependents to be deleted [Conformance] [Serial]
...
## [Garbage Collector, delete deployment, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L547)
...
## [Garbage Collector, delete replication controller, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/garbage_collector.go#L388)

- Added to conformance in release v1.9
- Defined in code as: [sig-api-machinery] Garbage collector should orphan pods created by rc if delete options say so [Conformance] [Serial]
...
## [MutatingAdmissionPolicy](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/mutatingadmissionpolicy.go#L131)

- Added to conformance in release v1.36
- Defined in code as: [sig-api-machinery] MutatingAdmissionPolicy [Privileged:ClusterAdmin] should mutate a Deployment [Conformance]

 The MutatingAdmissionPolicy should mutate a deployment as the expression defined inside the policy.

## [MutatingAdmissionPolicy](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/mutatingadmissionpolicy.go#L70)

- Added to conformance in release v1.36
- Defined in code as: [sig-api-machinery] MutatingAdmissionPolicy [Privileged:ClusterAdmin] should mutate a Deployment with annotations [Conformance]

 The MutatingAdmissionPolicy should mutate a deployment by adding annotations as defined in the policy.

## [MutatingAdmissionPolicy API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/mutatingadmissionpolicy.go#L192)

- Added to conformance in release v1.36
- Defined in code as: [sig-api-machinery] MutatingAdmissionPolicy [Privileged:ClusterAdmin] should support MutatingAdmissionPolicy API operations [Conformance]

 The admissionregistration.k8s.io API group MUST exist in the /apis discovery document. The admissionregistration.k8s.io/v1 API group/version MUST exist in the /apis/admissionregistration.k8s.io discovery document. The mutatingadmissionpolicies resource MUST exist in the /apis/admissionregistration.k8s.io/v1 discovery document. The mutatingadmissionpolicies resource must support create, get, list, watch, update, patch, delete, and deletecollection.

## [MutatingAdmissionPolicyBinding API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/mutatingadmissionpolicy.go#L414)

- Added to conformance in release v1.36
- Defined in code as: [sig-api-machinery] MutatingAdmissionPolicy [Privileged:ClusterAdmin] should support MutatingAdmissionPolicyBinding API operations [Conformance]

 The admissionregistration.k8s.io API group MUST exist in the /apis discovery document. The admissionregistration.k8s.io/v1 API group/version MUST exist in the /apis/admissionregistration.k8s.io discovery document. The MutatingAdmissionPolicyBinding resources MUST exist in the /apis/admissionregistration.k8s.io/v1 discovery document. The MutatingAdmissionPolicyBinding resource must support create, get, list, watch, update, patch, delete, and deletecollection.

## [Namespace, apply finalizer to a namespace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L404)

- Added to conformance in release v1.26
- Defined in code as: [sig-api-machinery] Namespaces should apply a finalizer to a Namespace [Conformance] [Serial]
...
## [Namespace, apply update to a namespace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L376)

- Added to conformance in release v1.26
- Defined in code as: [sig-api-machinery] Namespaces should apply an update to a Namespace [Conformance] [Serial]

When updating the namespace it MUST succeed and the field MUST equal the new value.

## [Namespace, apply changes to a namespace status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L309)

- Added to conformance in release v1.25
- Defined in code as: [sig-api-machinery] Namespaces should apply changes to a namespace status [Conformance] [Serial]
...
## [namespace-deletion-removes-pods](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L247)

- Added to conformance in release v1.11
- Defined in code as: [sig-api-machinery] Namespaces should ensure that all pods are removed when a namespace is deleted [Conformance] [Serial]

Ensure that if a namespace is deleted then all pods are removed from that namespace.

## [namespace-deletion-removes-services](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L256)

- Added to conformance in release v1.11
- Defined in code as: [sig-api-machinery] Namespaces should ensure that all services are removed when a namespace is deleted [Conformance] [Serial]

Ensure that if a namespace is deleted then all services are removed from that namespace.

## [Namespace patching](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L276)

- Added to conformance in release v1.18
- Defined in code as: [sig-api-machinery] Namespaces should patch a Namespace [Conformance] [Serial]

A Namespace is created. The Namespace is patched. The Namespace and MUST now include the new Label.

## [Ordered Namespace Deletion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/namespace.go#L492)

- Added to conformance in release v1.34
- Defined in code as: [sig-api-machinery] OrderedNamespaceDeletion namespace deletion should delete pod first [Conformance]

Pods must be deleted before other objects when deleting a namespace. See https://kep.k8s.io/5080

## [ResourceQuota, apply changes to a ResourceQuota status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L1078)
...
## [ResourceQuota, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L950)
...
## [ResourceQuota, object count quota, configmap](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L339)
...
## [ResourceQuota, object count quota, pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L243)
...
## [ResourceQuota, object count quota, replicaSet](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L462)
...
## [ResourceQuota, object count quota, replicationController](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L406)
...
## [ResourceQuota, object count quota, secret](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L172)
...
## [ResourceQuota, object count quota, service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L112)
...
## [ResourceQuota, object count quota, resourcequotas](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L87)
...
## [ResourceQuota, manage lifecycle of a ResourceQuota](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L1009)
...
## [ResourceQuota, quota scope, BestEffort and NotBestEffort scope](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L869)
...
## [ResourceQuota, quota scope, Terminating and NotTerminating scope](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/resource_quota.go#L754)
...
## [API Chunking, server should return chunks of results for list calls](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/chunking.go#L83)
...
## [API Chunking, server should support continue listing from the last key even if the original version has been compacted away](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/chunking.go#L144)

- Added to conformance in release v1.29
- Defined in code as: [sig-api-machinery] Servers with support for API chunking should support continue listing from the last key if the original version has been compacted away, though the list is inconsistent [Conformance] [Slow]
...
## [API metadata HTTP return](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/table_conversion.go#L154)
...
## [CRUD operations for storageversionmigrations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/storage_version_migration.go#L43)

- Added to conformance in release v1.37
- Defined in code as: [sig-api-machinery] StorageVersionMigration CRUD Tests storagemigration.k8s.io/v1 StorageVersionMigration [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for storagemigration.k8s.io/v1 StorageVersionMigration.

## [ValidatingAdmissionPolicy](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/validatingadmissionpolicy.go#L223)
...
## [ValidatingAdmissionPolicy API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/validatingadmissionpolicy.go#L413)
...
## [ValidatingadmissionPolicyBinding API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/validatingadmissionpolicy.go#L682)
...
## [ValidatingAdmissionPolicy](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/validatingadmissionpolicy.go#L79)
...
## [watch-configmaps-closed-and-restarted](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/watch.go#L191)
...
## [watch-configmaps-from-resource-version](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/watch.go#L142)
...
## [watch-configmaps-with-multiple-watchers](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/watch.go#L60)
...
## [watch-configmaps-label-changed](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/watch.go#L257)
...
## [watch-consistency](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/watch.go#L334)
...
## [Confirm a server version](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apimachinery/server_version.go#L41)
...
## [ControllerRevision, resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/controller_revision.go#L128)

- Added to conformance in release v1.25
- Defined in code as: [sig-apps] ControllerRevision should manage the lifecycle of a ControllerRevision [Conformance] [Serial]
...
## [CronJob Suspend](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/cronjob.go#L99)

- Added to conformance in release v1.21
- Defined in code as: [sig-apps] CronJob should not schedule jobs when suspended [Conformance] [Slow]

CronJob MUST support suspension, which suppresses creation of new jobs.

## [CronJob ForbidConcurrent](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/cronjob.go#L127)

- Added to conformance in release v1.21
- Defined in code as: [sig-apps] CronJob should not schedule new jobs when ForbidConcurrent [Conformance] [Slow]

CronJob MUST support ForbidConcurrent policy, allowing to run single, previous job at the time.

## [CronJob ReplaceConcurrent](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/cronjob.go#L170)
...
## [CronJob AllowConcurrent](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/cronjob.go#L72)
...
## [CronJob API Operations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/cronjob.go#L368)
...
## [DaemonSet, list and delete a collection of DaemonSets](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L856)

- Added to conformance in release v1.22
- Defined in code as: [sig-apps] Daemon set should list and delete a collection of DaemonSets [Conformance] [Serial]
...
## [DaemonSet-FailedPodCreation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L307)

- Added to conformance in release v1.10
- Defined in code as: [sig-apps] Daemon set should retry creating failed daemon pods [Conformance] [Serial]

A conformant Kubernetes distribution MUST create new DaemonSet Pods when they fail.

## [DaemonSet-Rollback](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L448)

- Added to conformance in release v1.10
- Defined in code as: [sig-apps] Daemon set should rollback without unnecessary restarts [Conformance] [Serial]

A conformant Kubernetes distribution MUST support automated, minimally disruptive rollback of updates to a DaemonSet.

## [DaemonSet-NodeSelection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L207)
...
## [DaemonSet-Creation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L179)

- Added to conformance in release v1.10
- Defined in code as: [sig-apps] Daemon set should run and stop simple daemon [Conformance] [Serial]
...
## [DaemonSet-RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L387)

- Added to conformance in release v1.10
- Defined in code as: [sig-apps] Daemon set should update pod when spec was updated and update strategy is RollingUpdate [Conformance] [Serial]

A conformant Kubernetes distribution MUST support DaemonSet RollingUpdates.

## [DaemonSet, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/daemon_set.go#L895)

- Added to conformance in release v1.22
- Defined in code as: [sig-apps] Daemon set should verify changes to a daemon set status [Conformance] [Serial]
...
## [Deployment, completes the scaling of a Deployment subresource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L152)
...
## [Deployment Recreate](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L115)
...
## [Deployment RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L107)
...
## [Deployment RevisionHistoryLimit](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L124)
...
## [Deployment Proportional Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L162)
...
## [Deployment Rollover](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L134)
...
## [Deployment, completes the lifecycle of a Deployment](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L186)
...
## [Deployment, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/deployment.go#L491)
...
## [PodDisruptionBudget: list and delete collection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/disruption.go#L92)
...
## [PodDisruptionBudget: block an eviction until the PDB is updated to allow it](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/disruption.go#L355)
...
## [PodDisruptionBudget: create, update, patch, and delete object](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/disruption.go#L113)
...
## [PodDisruptionBudget: Status updates](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/disruption.go#L148)
...
## [PodDisruptionBudget: update and patch status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/disruption.go#L171)
...
## [Jobs, orphan pods, re-adoption](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L1072)
...
## [Ensure pod failure policy allows to ignore failure matching on the DisruptionTarget condition](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L352)
...
## [Verify Pod Failure policy allows to fail job early on exit code.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L263)
...
## [Jobs, apply changes to status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L1219)
...
## [Ensure Pods of an Indexed Job get a unique index.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L561)
...
## [Jobs, active pods, graceful termination](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L1043)
...
## [Ensure that all indexes are executed for an indexed job with backoffLimitPerIndex despite some failing](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L760)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job should execute all indexes despite some failing when using backoffLimitPerIndex [Conformance]

Create an indexed job and ensure that all indexes are either failed or succeeded, depending on the end state of the corresponding pods. Pods with odd indexes fail, while the pods with even indexes succeeded. Also, verify that the number of failed pods doubles the number of failing indexes, as the backoffLimitPerIndex=1, allowing for one pod recreation before marking that indexed failed.

## [Jobs, manage lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L1313)
...
## [Mark indexes as failed when the FailIndex action is matched in podFailurePolicy](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L881)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job should mark indexes as failed when the FailIndex action is matched in podFailurePolicy [Conformance]

Create an indexed job with backoffLimitPerIndex, and podFailurePolicy with the FailIndex action. Verify the failed pods matching the pod failure policy result in marking the corresponding indexes as failed without restarts, despite backoffLimitPerIndex > 0.

## [Jobs, completion after task failure](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L953)
...
## [Terminate job execution when the maxFailedIndexes is exceeded](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L794)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job should terminate job execution when the number of failed indexes exceeds maxFailedIndexes [Conformance]

Create an indexed job with backoffLimitPerIndex and maxFailedIndexes. Verify the job execution is terminated as soon as the number of failed indexes exceeds maxFailedIndexes.

## [Ensure that job with successPolicy succeeded when all indexes succeeded](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L639)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job with successPolicy should succeeded when all indexes succeeded [Conformance]

Create an indexed job with successPolicy. Verify that job got SuccessCriteriaMet with SuccessPolicy reason and Complete condition once all indexes succeeded.

## [Ensure that job with successPolicy succeededCount rule succeeded even when some indexes remain pending](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L719)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job with successPolicy succeededCount rule should succeeded even when some indexes remain pending [Conformance]

Create an indexed job with successPolicy succeededCount rule. Verify that the job got the SuccessCriteriaMet with SuccessPolicy reason condition and Complete condition when the job met successPolicy even if some indexed remain pending.

## [Ensure that job with successPolicy succeededIndexes rule succeeded even when some indexes remain pending](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/job.go#L679)

- Added to conformance in release v1.33
- Defined in code as: [sig-apps] Job with successPolicy succeededIndexes rule should succeeded even when some indexes remain pending [Conformance]

Create an indexed job with successPolicy succeededIndexes rule. Verify that the job got SuccessCriteriaMet with SuccessPolicy reason condition and Complete condition when the job met successPolicy even if some indexed remain pending.

## [ReplicaSet, is created, Replaced and Patched](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L154)
...
## [ReplicaSet, completes the scaling of a ReplicaSet subresource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L143)
...
## [Replica Set, adopt matching pods and release non matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L131)
...
## [ReplicaSet, list and delete a collection of ReplicaSets](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L165)
...
## [Replica Set, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L113)
...
## [ReplicaSet, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/replica_set.go#L176)
...
## [Replication Controller, adopt matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L95)
...
## [Replication Controller, get and update ReplicationController scale](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L427)
...
## [Replication Controller, release pods](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L104)
...
## [Replication Controller, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L72)
...
## [Replication Controller, check for issues like exceeding allocated quota](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L86)
...
## [Replication Controller, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/rc.go#L113)
...
## [StatefulSet, Burst Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L833)

- Added to conformance in release v1.9
- Defined in code as: [sig-apps] StatefulSet Basic StatefulSet functionality [StatefulSetBasic] Burst scaling should run to completion even with unhealthy pods [Conformance] [Slow]
...
## [StatefulSet, Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L723)

- Added to conformance in release v1.9
- Defined in code as: [sig-apps] StatefulSet Basic StatefulSet functionality [StatefulSetBasic] Scaling should happen in predictable order and halt if any stateful pod is unhealthy [Conformance] [Slow]
...
## [StatefulSet, Recreate Failed Pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L875)
...
## [StatefulSet resource Replica scaling](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L984)
...
## [StatefulSet, list, patch and delete a collection of StatefulSets](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L1044)
...
## [StatefulSet, Rolling Update with Partition](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L336)
...
## [StatefulSet, Rolling Update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L325)
...
## [StatefulSet, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/apps/statefulset.go#L1115)
...
## [Conformance tests minimum number of nodes.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/architecture/conformance.go#L39)
...
## [CertificateSigningRequest API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/certificates.go#L202)
...
## [PodCertificateRequest API operations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/podcertificaterequest.go#L51)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] PodCertificateRequest API [Privileged:ClusterAdmin] should support PodCertificateRequest API operations [Conformance]

 The certificates.k8s.io API group MUST exist in the /apis discovery document. The certificates.k8s.io/v1 API group/version MUST exist in the /apis/certificates.k8s.io discovery document. The podcertificaterequests and podcertificaterequests/status resources MUST exist in the /apis/certificates.k8s.io/v1 discovery document. The podcertificaterequests resource must support namespaced create, read, update, patch, and delete. The podcertificaterequests/status resource must support get, update, patch.

## [Projected PodCertificate Default Expiration](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L191)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] MaxExpirationSeconds validations should issue certificate with default life time (24h) when MaxExpirationSeconds is not set [MinimumKubeletVersion:1.37] [Conformance]
...
## [Projected PodCertificate Custom Expiration](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L232)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] MaxExpirationSeconds validations should issue certificate with specified duration (1h) when MaxExpirationSeconds is set [MinimumKubeletVersion:1.37] [Conformance]
...
## [Projected PodCertificate Expiration Maximum Validation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L274)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] MaxExpirationSeconds validations should reject pod creation when MaxExpirationSeconds exceeds maximum (91d) [MinimumKubeletVersion:1.37] [Conformance]
...
## [Projected PodCertificate Expiration Minimum Validation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L297)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] MaxExpirationSeconds validations should reject pod creation when MaxExpirationSeconds is less than minimum (1h) [MinimumKubeletVersion:1.37] [Conformance]
...
## [Projected PodCertificate mTLS Connection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L84)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should allow server and client pods to establish an mTLS connection [MinimumKubeletVersion:1.37] [Conformance]

 A pod configured with a projected podCertificate volume and an associated ClusterTrustBundle MUST project a valid leaf certificate chain and key. Two pods configured with such certificates and keys under the same CA MUST be able to establish a mutually authenticated TLS (mTLS) connection.

## [Projected PodCertificate UserAnnotations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_podcertificate.go#L136)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] Projected PodCertificate [FeatureGate:PodCertificateRequest] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should honor UserAnnotations for SPIFFE URI path [MinimumKubeletVersion:1.37] [Conformance]

 The podCertificate volume projection MUST support passing unverified user annotations from the pod spec to the signer. The signer MUST be able to receive and process these annotations (e.g. to override the SPIFFE URI path in the generated certificate SANs).

## [OIDC Discovery (ServiceAccountIssuerDiscovery)](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L674)
...
## [Service account tokens auto mount optionally](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L194)
...
## [ServiceAccount, create and review token](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L995)
...
## [RootCA ConfigMap test](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L888)
...
## [Service Account Tokens Must AutoMount](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L82)
...
## [TokenRequestProjection should mount a projected volume with token using TokenRequest API.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L308)
...
## [ServiceAccount lifecycle test](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L792)
...
## [ServiceAccount, update a ServiceAccount](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/service_accounts.go#L956)
...
## [SubjectReview, API Operations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/subjectreviews.go#L50)
...
## [CRUD operations for clustertrustbundles](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L80)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] CRUD Tests certificates.k8s.io/v1 ClusterTrustBundles [MinimumKubeletVersion:1.37] [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for certificates.k8s.io/v1 ClusterTrustBundles

## [Mounting big number (>100) of ClusterTrustBundle volumes](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L336)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be able to mount a big number (>100) of CTBs [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST be able to mount a big number of volumes of ClusterTrustBundle type.

## [Mounting a single ClusterTrustBundle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L114)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be able to mount a single ClusterTrustBundle by name [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST be able to mount contents of these API objects inside of pods.

## [Mounting multiple ClusterTrustBundle volumes](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L302)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be able to specify multiple CTB volumes [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST be able to mount multiple volumes of ClusterTrustBundle type.

## [Mounting multiple ClusterTrustBundles](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L197)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be capable to mount multiple trust bundles by signer+labels can combine all signer CTBs with an empty label selector [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST be able to mount contents of these API objects inside of pods using different kinds of selectors.

## [Mounting multiple ClusterTrustBundles](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L197)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be capable to mount multiple trust bundles by signer+labels can combine multiple CTBs with signer name and label selector [MinimumKubeletVersion:1.37] [Conformance]
...
- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be capable to mount multiple trust bundles by signer+labels should start if only signer name and explicit label selector matches nothing + optional=true [MinimumKubeletVersion:1.37] [Conformance]
...
- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should be capable to mount multiple trust bundles by signer+labels should start if only signer name and nil label selector + optional=true [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST be able to mount contents of these API objects inside of pods using different kinds of selectors.

## [Failing to mount improperly defined ClusterTrustBundles](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L250)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should prevent a pod from starting if: sets optional=false and no trust bundle matches query [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST fail to mount these objects if none match the provided selector.

## [Failing to mount improperly defined ClusterTrustBundles](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/auth/projected_clustertrustbundle.go#L250)

- Added to conformance in release v1.37
- Defined in code as: [sig-auth] [FeatureGate:ClusterTrustBundle] [FeatureGate:ClusterTrustBundleProjection] should prevent a pod from starting if: sets optional=false and the configured CTB does not exist [MinimumKubeletVersion:1.37] [Conformance]

The API server MUST serve the ClusterTrustBundle API and the kubelet MUST fail to mount these objects if none match the provided selector.

## [Kubectl, guestbook application](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L412)
...
## [Kubectl, check version v1](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L915)
...
## [Kubectl, cluster info](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1261)
...
## [Kubectl, describe pod or rc](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1287)
...
## [Kubectl, diff Deployment](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L943)
...
Create a Deployment with agnhost image. Declare the same Deployment with a different image, busybox. Diff of live Deployment with declared Deployment MUST include the difference between live and declared image.

## [Kubectl, create service, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1428)
...
## [Kubectl, label update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1522)
...
## [Kubectl, patch to annotate](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1588)
...
## [Kubectl, replace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1689)
...
## [Kubectl, run pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1654)
...
## [Kubectl, server-side dry-run Pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L974)
...
## [Kubectl, version](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1621)
...
## [Kubectl, proxy socket](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1756)
...
## [Kubectl, proxy port zero](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L1731)
...
## [Kubectl, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L356)
...
## [Kubectl, scale replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/kubectl.go#L369)
...
## [Kubectl, logs](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/kubectl/logs.go#L167)
...
## [New Event resource lifecycle, testing a list of events](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/instrumentation/events.go#L211)
...
## [New Event resource lifecycle, testing a single event](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/instrumentation/events.go#L100)
...
## [Event, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/instrumentation/core_events.go#L176)
...
## [Event, manage lifecycle of an Event](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/instrumentation/core_events.go#L58)
...
## [kubernetes.default Endpoints and EndpointSlices](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/apiserver.go#L58)

- Added to conformance in release v1.21
- Defined in code as: [sig-network] API Server should have Endpoints and EndpointSlices pointing to API Server [Conformance]

The "kubernetes.default" service MUST have Endpoints and EndpointSlices pointing to each API server instance.

## [Kubernetes Service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/apiserver.go#L48)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] API Server should provide secure master service [Conformance]

By default when a kubernetes cluster is running there MUST be a 'kubernetes' service running in the cluster.

## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L130)
...
## [DNS, for ExternalName Services](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L400)
...
## [DNS, resolve the hostname](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L323)
...
## [DNS, resolve the subdomain](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L361)
...
## [DNS, services](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L152)
...
## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L55)
...
## [DNS, PQDN for services](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L276)
...
## [DNS, custom dnsConfig](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/dns.go#L479)
...
## [EndpointSlice, creation/deletion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslice.go#L144)

- Added to conformance in release v1.21, v1.35
...
The endpointslice controller must create and delete EndpointSlices for Pods matching a Service.

## [EndpointSlice, "empty" Service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslice.go#L67)

- Added to conformance in release v1.21, v1.35
- Defined in code as: [sig-network] EndpointSlice should create and delete EndpointSlices for a Service with a selector that matches no pods [Conformance]

The EndpointSlice controller should create and delete empty EndpointSlices for a Service that matches no pods.

## [EndpointSlice, multiple IPs, multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslice.go#L570)

- Added to conformance in release v1.34
- Defined in code as: [sig-network] EndpointSlice should support a Service with multiple endpoint IPs specified in multiple EndpointSlices [Conformance]

Given a selector-less Service with multiple manually-created EndpointSlices (and no Endpoints) where the endpoints have different IPs and different Ports, the service proxy MUST allow connections to both ports.

## [EndpointSlice, single IP, multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslice.go#L458)

- Added to conformance in release v1.34
- Defined in code as: [sig-network] EndpointSlice should support a Service with multiple ports specified in multiple EndpointSlices [Conformance]

Given a selector-less Service with multiple manually-created EndpointSlices (and no Endpoints) where the endpoints have the same IP but different Ports, the service proxy MUST allow connections to both ports.

## [EndpointSlice API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslice.go#L274)
...
## [EndpointSlice Mirroring](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpointslicemirroring.go#L55)
...
## [Endpoint resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpoints.go#L58)

- Added to conformance in release v1.19
- Defined in code as: [sig-network] Endpoints should test the lifecycle of an Endpoint [Conformance]

Create an endpoint, the endpoint MUST exist. The endpoint is updated with a new label, a check after the update MUST find the changes. The endpoint is then patched with a new IPv4 address and port, a check after the patch MUST the changes. The endpoint is deleted by its label, a watch listens for the deleted watch event.

## [Endpoints, creation/deletion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpoints.go#L307)

- Added to conformance in release v1.21, v1.35
- Defined in code as: [sig-network] EndpointsController should create Endpoints for Pods matching a Service [Conformance]

The Endpoints controller must create an Endpoints for Pods matching a Service.

## [Endpoints, "empty" Service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/endpoints.go#L254)

- Added to conformance in release v1.21, v1.35
- Defined in code as: [sig-network] EndpointsController should create and delete Endpoints for a Service with a selector that matches no pods [Conformance]

The Endpoints controller should create and delete an empty Endpoints for a Service that matches no pods.

## [Scheduling, HostPort matching and HostIP and Protocol not-matching](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/hostport.go#L63)
...
## [Ingress API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/ingress.go#L57)
...
## [IngressClass API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/ingressclass.go#L278)
...
## [Networking, intra pod http](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/network/networking.go#L85)

- Added to conformance in release v1.9, v1.18
- Defined in code as: [sig-network] Networking Granular Checks: Pods should function for intra-pod communication: http [Conformance] [NodeConformance]
...
## [Networking, intra pod udp](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/network/networking.go#L96)

- Added to conformance in release v1.9, v1.18
- Defined in code as: [sig-network] Networking Granular Checks: Pods should function for intra-pod communication: udp [Conformance] [NodeConformance]
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/network/networking.go#L108)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Networking Granular Checks: Pods should function for node-pod communication: http [LinuxOnly] [Conformance] [NodeConformance]
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/network/networking.go#L125)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Networking Granular Checks: Pods should function for node-pod communication: udp [LinuxOnly] [Conformance] [NodeConformance]
...
## [Proxy, validate Proxy responses](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/proxy.go#L432)
...
## [Proxy, validate ProxyWithPath responses](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/proxy.go#L338)
...
## [Proxy through apiserver to a Service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/proxy.go#L100)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Proxy version v1 should proxy through a service and a pod [Conformance]

The apiserver will proxy a connection to a Service.

## [Service endpoint latency, thresholds](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service_latency.go#L60)
...
## [IPAddress API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service_cidrs.go#L212)

- Added to conformance in release v1.34
- Defined in code as: [sig-network] ServiceCIDR and IPAddress API should support IPAddress API operations [Conformance]

 The networking.k8s.io API group MUST exist in the /apis discovery document. The networking.k8s.io/v1 API group/version MUST exist in the /apis/networking.k8s.io discovery document. The ipaddresses resources MUST exist in the /apis/networking.k8s.io/v1 discovery document. The ipaddresses resource must support create, get, list, watch, update, patch, delete, and deletecollection.

## [ServiceCIDR API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service_cidrs.go#L166)

- Added to conformance in release v1.34
- Defined in code as: [sig-network] ServiceCIDR and IPAddress API should support ServiceCIDR API operations [Conformance]

 The networking.k8s.io API group MUST exist in the /apis discovery document. The networking.k8s.io/v1 API group/version MUST exist in the /apis/networking.k8s.io discovery document. The servicecidrs resources MUST exist in the /apis/networking.k8s.io/v1 discovery document. The servicecidrs resource must support create, get, list, watch, update, patch, delete, and deletecollection. The servicecidrs/status resource must support update and patch

## [Service, change type, ClusterIP to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L1500)
...
## [Service, change type, ExternalName to ClusterIP](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L1423)
...
## [Service, change type, ExternalName to NodePort](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L1462)
...
## [Service, change type, NodePort to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L1540)
...
## [Service, NodePort Service](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L1287)
...
## [Service, NodePort type, session affinity to None](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L2288)
...
## [Service, deletes a collection of services](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L3502)
...
## [Find Kubernetes Service in default Namespace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L3250)
...
## [Service, NodePort type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L2266)

- Added to conformance in release v1.19
- Defined in code as: [sig-network] Services should have session affinity work for NodePort service [LinuxOnly] [Conformance]

Create a service of type "NodePort" and provide service port and protocol. Service's sessionAffinity is set to "ClientIP". Service creation MUST be successful by assigning a "ClusterIP" to service and allocating NodePort on all nodes. Create a Deployment to ensure that 3 pods are running and are targeted by the service to serve hostname of the pod when a requests are sent to the service. Create another pod to make requests to the service on node's IP and NodePort. Service MUST serve the hostname from the same pod of the replica for all consecutive requests. Service MUST be reachable over serviceName and the ClusterIP on servicePort. Service MUST also be reachable over node's IP on NodePort. [LinuxOnly]: Windows does not support session affinity.

## [Service, ClusterIP type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L2229)
...
## [Service, endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L733)
...
## [Service, should serve endpoints on same port and different protocols.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L3586)
...
## [Service, endpoints with multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/network/service.go#L803)
...
## [ConfigMap, from environment field with various prefixes](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L261)

- Added to conformance in release v1.34
- Defined in code as: [sig-node] ConfigMap should be consumable as environment variable names with various prefixes [Conformance]

Create a Pod with environment variable values set using values from ConfigMap. Allows users to use envFrom to set prefixes with various printable ASCII characters excluding '=' as environment variable names. This test verifies that different prefixes including digits, special characters, and letters can be correctly used.

## [ConfigMap, from environment field](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L48)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] ConfigMap should be consumable via environment variable [Conformance] [NodeConformance]
...
## [ConfigMap, from environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L96)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] ConfigMap should be consumable via the environment [Conformance] [NodeConformance]
...
## [ConfigMap, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L141)
...
## [ConfigMap lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L176)
...
## [ConfigMap Update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/configmap.go#L150)

- Added to conformance in release v1.32
- Defined in code as: [sig-node] ConfigMap should update ConfigMap successfully [Conformance] [NodeConformance]

Ensure that a ConfigMap object can be created and then updated successfully.

## [Pod Lifecycle, post start exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/lifecycle_hook.go#L163)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Container Lifecycle Hook when create a pod with lifecycle hook should execute poststart exec hook properly [Conformance] [NodeConformance]
...
## [Pod Lifecycle, post start http hook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/lifecycle_hook.go#L196)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Container Lifecycle Hook when create a pod with lifecycle hook should execute poststart http hook properly [Conformance] [NodeConformance]
...
## [Pod Lifecycle, prestop exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/lifecycle_hook.go#L180)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Container Lifecycle Hook when create a pod with lifecycle hook should execute prestop exec hook properly [Conformance] [NodeConformance]
...
## [Pod Lifecycle, prestop http hook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/lifecycle_hook.go#L239)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Container Lifecycle Hook when create a pod with lifecycle hook should execute prestop http hook properly [Conformance] [NodeConformance]
...
## [Container Runtime, TerminationMessage, from log output of succeeding container](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtime.go#L233)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Container Runtime blackbox test on terminated container should report termination message as empty when pod succeeds and TerminationMessagePolicy FallbackToLogsOnError is set [Conformance] [NodeConformance]
...
## [Container Runtime, TerminationMessage, from file of succeeding container](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtime.go#L249)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Container Runtime blackbox test on terminated container should report termination message from file when pod succeeds and TerminationMessagePolicy FallbackToLogsOnError is set [Conformance] [NodeConformance]
...
## [Container Runtime, TerminationMessage, from container's log output of failing container](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtime.go#L217)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Container Runtime blackbox test on terminated container should report termination message from log output if TerminationMessagePolicy FallbackToLogsOnError is set [Conformance] [NodeConformance]
...
## [Container Runtime, TerminationMessagePath, non-root user and non-default path](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtime.go#L196)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Container Runtime blackbox test on terminated container should report termination message if TerminationMessagePath is set as non-root user and at a non-default path [Conformance] [NodeConformance]
...
## [Container Runtime, Restart Policy, Pod Phases](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtime.go#L53)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Container Runtime blackbox test when starting a container that exits should run with the expected status [Conformance] [NodeConformance]
...
## [Containers, with arguments](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/containers.go#L62)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Containers should be able to override the image's default arguments (container cmd) [Conformance] [NodeConformance]
...
## [Containers, with command](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/containers.go#L76)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Containers should be able to override the image's default command (container entrypoint) [Conformance] [NodeConformance]
...
## [Containers, with command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/containers.go#L90)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Containers should be able to override the image's default command and arguments [Conformance] [NodeConformance]
...
## [Containers, without command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/containers.go#L42)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Containers should use the image defaults if command and args are blank [Conformance] [NodeConformance]
...
## [DownwardAPI, environment for CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L197)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Downward API should provide container's limits.cpu/memory and requests.cpu/memory as env vars [Conformance] [NodeConformance]

Downward API MUST expose CPU request and Memory request set through environment variables at runtime in the container.

## [DownwardAPI, environment for default CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L248)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Downward API should provide default limits.cpu/memory from node allocatable [Conformance] [NodeConformance]

Downward API MUST expose CPU request and Memory limits set through environment variables at runtime in the container.

## [DownwardAPI, environment for host ip](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L95)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Downward API should provide host IP as an env var [Conformance] [NodeConformance]
...
## [DownwardAPI, environment for hostIPs](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L121)

- Added to conformance in release v1.32
- Defined in code as: [sig-node] Downward API should provide hostIPs as an env var [Conformance] [NodeConformance]

Downward API MUST expose Pod and Container fields as environment variables. Specify hostIPs as environment variable in the Pod Spec are visible at runtime in the container.

## [DownwardAPI, environment for Pod UID](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L298)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Downward API should provide pod UID as env vars [Conformance] [NodeConformance]

Downward API MUST expose Pod UID set through environment variables at runtime in the container.

## [DownwardAPI, environment for name, namespace and ip](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/downwardapi.go#L49)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Downward API should provide pod name, namespace and IP address as env vars [Conformance] [NodeConformance]
...
## [Ephemeral Container, update ephemeral containers](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/ephemeral_containers.go#L108)

- Added to conformance in release v1.28
- Defined in code as: [sig-node] Ephemeral Containers should update the ephemeral containers in an existing pod [Conformance] [NodeConformance]
...
## [Ephemeral Container Creation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/ephemeral_containers.go#L51)

- Added to conformance in release 1.25
- Defined in code as: [sig-node] Ephemeral Containers will start an ephemeral container in an existing pod [Conformance] [NodeConformance]

Adding an ephemeral container to pod.spec MUST result in the container running.

## [Image Volume](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/image_volume.go#L97)

- Added to conformance in release v1.36
- Defined in code as: [sig-node] ImageVolume should succeed with pod and pull policy of Always [LinuxOnly] [MinimumKubeletVersion:1.35] [Conformance]

Create a Pod using an image volume and a pull policy of Always. This test verifies that the image volume functionality is available by default and works as intended. [LinuxOnly]: This test is marked as LinuxOnly since Windows does not support image volumes.

## [init-container-starts-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/init_container.go#L256)

- Added to conformance in release v1.12
- Defined in code as: [sig-node] InitContainer should invoke init containers on a RestartAlways pod [Conformance] [NodeConformance]
...
## [init-container-starts-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/init_container.go#L178)

- Added to conformance in release v1.12
- Defined in code as: [sig-node] InitContainer should invoke init containers on a RestartNever pod [Conformance] [NodeConformance]
...
## [init-container-fails-stops-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/init_container.go#L459)

- Added to conformance in release v1.12
- Defined in code as: [sig-node] InitContainer should not start app containers and fail the pod if init containers fail on a RestartNever pod [Conformance] [NodeConformance]
...
## [init-container-fails-stops-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/init_container.go#L335)

- Added to conformance in release v1.12
- Defined in code as: [sig-node] InitContainer should not start app containers if init containers fail on a RestartAlways pod [Conformance] [NodeConformance]
...
## [Kubelet, log output, default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/kubelet.go#L52)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Kubelet when scheduling a busybox command in a pod should print the output to logs [Conformance] [NodeConformance]

By default the stdout and stderr from the process being executed in a pod MUST be sent to the pod's logs.

## [Kubelet, failed pod, delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/kubelet.go#L135)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Kubelet when scheduling a busybox command that always fails in a pod should be possible to delete [Conformance] [NodeConformance]

Create a Pod with terminated state. This terminated pod MUST be able to be deleted.

## [Kubelet, failed pod, terminated reason](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/kubelet.go#L110)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Kubelet when scheduling a busybox command that always fails in a pod should have an terminated reason [Conformance] [NodeConformance]
...
## [Kubelet, pod with read only root file system](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/kubelet.go#L184)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Kubelet when scheduling a read only busybox container should not write to root filesystem [LinuxOnly] [Conformance] [NodeConformance]
...
## [Kubelet, hostAliases](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/kubelet.go#L148)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Kubelet when scheduling an agnhost Pod with hostAliases should write entries to /etc/hosts [Conformance] [NodeConformance]
...
## [Pod Eviction, Toleration limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/taints.go#L444)

- Added to conformance in release v1.16
- Defined in code as: [sig-node] NoExecuteTaintManager Multiple Pods evicts pods with minTolerationSeconds [Conformance] [Disruptive] [Serial]

In a multi-pods scenario with tolerationSeconds, the pods MUST be evicted as per the toleration time limit.

## [Taint, Pod Eviction on taint removal](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/taints.go#L284)

- Added to conformance in release v1.16
- Defined in code as: [sig-node] NoExecuteTaintManager Single Pod removing taint cancels eviction [Conformance] [Disruptive] [Serial]
...
## [Node, resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/node_lifecycle.go#L53)

- Added to conformance in release v1.32
- Defined in code as: [sig-node] Node Lifecycle should run through the lifecycle of a node [Conformance]

Creating and Reading a Node MUST succeed with required name retrieved. Patching a Node MUST succeed with its new label found. Listing Nodes with a labelSelector MUST succeed with only a single node found. Updating a Node MUST succeed with its new label found. Deleting the Node MUST succeed and its deletion MUST be confirmed.

## [In-place Pod Resize, burtable pod with multiple containers and various operations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pod_resize.go#L275)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pod InPlace Resize Container burstable pods - extended 6 containers - various operations performed (including adding limits and requests) [MinimumKubeletVersion:1.34] [Conformance]

Issuing a Pod Resize request via the Pod Resize subresource patch endpoint to modify CPU and memory requests and limits on a 6-container pod with various operations MUST result in the Pod resources being updated as expected.

## [In-place Pod Resize, burstable pod resized with equivalents](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pod_resize.go#L338)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pod InPlace Resize Container burstable pods - extended resize with equivalents [MinimumKubeletVersion:1.34] [Conformance]

Issuing an in-place Pod Resize request via the Pod Resize subresource patch endpoint to modify CPU requests and limits using equivalent values (e.g. 2m -> 1m) MUST result in the updated Pod resources displayed correctly in the status.

## [In-place Pod Resize, read and replace endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pod_resize.go#L766)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pod InPlace Resize Container resize pod via the replace endpoint [MinimumKubeletVersion:1.34] [Conformance]

Issuing a Pod Resize request via the Pod Resize subresource replace endpoint MUST result in the Pod resources being updated as expected. The Pod object fetched from the Pod Resize subresource MUST be equivalent to the Pod object fetched from the main Pod endpoint after the resize is completed.

## [PodTemplate, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/podtemplates.go#L127)
...
## [PodTemplate, replace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/podtemplates.go#L181)
...
## [PodTemplate lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/podtemplates.go#L56)
...
## [Pods Generation, graceful delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/pods.go#L540)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pods Extended (pod generation) Pod Generation custom-set generation on new pods and graceful delete [Conformance]

Create a Pod, ensure that triggering a graceful delete causes the generation to be updated.

## [Pods Generation, 500 updates](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/pods.go#L581)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pods Extended (pod generation) Pod Generation issue 500 podspec updates and verify generation and observedGeneration eventually converge [MinimumKubeletVersion:1.34] [Conformance]

Create a Pod, issue 499 podSpec updates and verify generation and observedGeneration eventually converge to 500.

## [Pods Generation, updates](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/pods.go#L435)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] Pods Extended (pod generation) Pod Generation pod generation should start at 1 and increment per update [MinimumKubeletVersion:1.34] [Conformance]

Create a Pod, and perform a few updates, ensuring that the pod's metadata.generation and status.observedGeneration are updated as expected.

## [Pods, QOS](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/pods.go#L163)
...
## [Pods, ActiveDeadlineSeconds](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L402)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Pods should allow activeDeadlineSeconds to be updated [Conformance] [NodeConformance]
...
## [Pods, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L230)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Pods should be submitted and removed [Conformance] [NodeConformance]
...
## [Pods, update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L348)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Pods should be updated [Conformance] [NodeConformance]
...
## [Pods, service environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L448)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Pods should contain environment variables for services [Conformance] [NodeConformance]
...
## [Pods, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L859)
...
## [Pods, assigned hostip](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L208)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Pods should get a host IP [Conformance] [NodeConformance]

Create a Pod. Pod status MUST return successfully and contains a valid IP address.

## [Pods, patching status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L1097)
...
## [Pods, completes the lifecycle of a Pod and the PodStatus](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L909)
...
## [Pods, remote command execution over websocket](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L540)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Pods should support remote command execution over websockets [Conformance] [NodeConformance]
...
## [Pods, logs from websockets](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/pods.go#L622)

- Added to conformance in release v1.13
- Defined in code as: [sig-node] Pods should support retrieving logs from the container over websockets [Conformance] [NodeConformance]
...
## [Pods, prestop hook](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/pre_stop.go#L169)
...
## [Pod liveness probe, using http endpoint, failure](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L216)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container should *not* be restarted with a /healthz http liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using grpc call, success](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L529)

- Added to conformance in release v1.23
- Defined in code as: [sig-node] Probing container should *not* be restarted with a GRPC liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using local file, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L153)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container should *not* be restarted with a exec "cat /tmp/health" liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using tcp socket, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L185)

- Added to conformance in release v1.18
- Defined in code as: [sig-node] Probing container should *not* be restarted with a tcp:8080 liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using http endpoint, restart](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L170)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container should be restarted with a /healthz http liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using grpc call, failure](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L664)

- Added to conformance in release v1.23
- Defined in code as: [sig-node] Probing container should be restarted with a GRPC liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using local file, restart](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L136)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container should be restarted with a exec "cat /tmp/health" liveness probe [Conformance] [NodeConformance]
...
## [Pod liveness probe, using http endpoint, multiple restarts (slow)](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L200)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container should have monotonically increasing restart count [Conformance] [NodeConformance]
...
## [Pod readiness probe, with initial delay](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L73)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container with readiness probe should not be ready before initial delay and never restart [Conformance] [NodeConformance]
...
## [Pod readiness probe, failure](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/container_probe.go#L109)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Probing container with readiness probe that fails should never be ready and never restart [Conformance] [NodeConformance]
...
## [Pod with the deleted RuntimeClass is rejected.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtimeclass.go#L162)

- Added to conformance in release v1.20
- Defined in code as: [sig-node] RuntimeClass should reject a Pod requesting a deleted RuntimeClass [Conformance] [NodeConformance]

Pod requesting the deleted RuntimeClass must be rejected.

## [Pod with the non-existing RuntimeClass is rejected.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtimeclass.go#L59)

- Added to conformance in release v1.20
- Defined in code as: [sig-node] RuntimeClass should reject a Pod requesting a non-existent RuntimeClass [Conformance] [NodeConformance]

The Pod requesting the non-existing RuntimeClass must be rejected.

## [RuntimeClass Overhead field must be respected.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtimeclass.go#L135)

- Added to conformance in release v1.24
- Defined in code as: [sig-node] RuntimeClass should schedule a Pod requesting a RuntimeClass and initialize its Overhead [Conformance] [NodeConformance]
...
## [Can schedule a pod requesting existing RuntimeClass.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtimeclass.go#L110)

- Added to conformance in release v1.20
- Defined in code as: [sig-node] RuntimeClass should schedule a Pod requesting a RuntimeClass without PodOverhead [Conformance] [NodeConformance]

The Pod requesting the existing RuntimeClass must be scheduled. This test doesn't validate that the Pod will actually start because this functionality depends on container runtime and preconfigured handler. Runtime-specific functionality is not being tested here.

## [RuntimeClass API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/runtimeclass.go#L196)
...
## [Secrets, pod environment from source](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/secrets.go#L253)

- Added to conformance in release v1.34
- Defined in code as: [sig-node] Secrets should be consumable as environment variable names variable names with various prefixes [Conformance]
...
## [Secrets, pod environment field](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/secrets.go#L49)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Secrets should be consumable from pods in env vars [Conformance] [NodeConformance]
...
## [Secrets, pod environment from source](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/secrets.go#L98)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Secrets should be consumable via the environment [Conformance] [NodeConformance]
...
## [Secrets, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/secrets.go#L143)
...
## [Secret patching](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/secrets.go#L157)
...
## [Security Context, runAsUser=65534](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/security_context.go#L460)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Security Context When creating a container with runAsUser should run the container with uid 65534 [LinuxOnly] [Conformance] [NodeConformance]
...
## [Security Context, privileged=false.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/security_context.go#L641)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Security Context When creating a pod with privileged should run the container as unprivileged when false [LinuxOnly] [Conformance] [NodeConformance]
...
## [Security Context, readOnlyRootFilesystem=false.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/security_context.go#L599)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Security Context When creating a pod with readOnlyRootFilesystem should run the container with writable rootfs when readOnlyRootFilesystem=false [Conformance] [NodeConformance]
...
## [Security Context, test RunAsGroup at container level](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/security_context.go#L170)
...
## [Security Context, test RunAsGroup at pod level](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/node/security_context.go#L135)
...
## [Security Context, allowPrivilegeEscalation=false.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/security_context.go#L722)

- Added to conformance in release v1.15
- Defined in code as: [sig-node] Security Context when creating containers with AllowPrivilegeEscalation should not allow privilege escalation when false [LinuxOnly] [Conformance] [NodeConformance]
...
## [Sysctls, reject invalid sysctls](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/sysctl.go#L125)

- Added to conformance in release v1.21
- Defined in code as: [sig-node] Sysctls [LinuxOnly] should reject invalid sysctls [Conformance] [NodeConformance]
...
## [Sysctl, test sysctls](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/sysctl.go#L79)

- Added to conformance in release v1.21
- Defined in code as: [sig-node] Sysctls [LinuxOnly] should support sysctls [Environment:NotInUserNS] [Conformance] [NodeConformance]
...
## [Environment variables, expansion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L47)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Variable Expansion should allow composing env vars into new env vars [Conformance] [NodeConformance]
...
## [Environment variables, command argument expansion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L95)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Variable Expansion should allow substituting values in a container's args [Conformance] [NodeConformance]
...
## [Environment variables, command expansion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L76)

- Added to conformance in release v1.9
- Defined in code as: [sig-node] Variable Expansion should allow substituting values in a container's command [Conformance] [NodeConformance]
...
## [VolumeSubpathEnvExpansion, subpath expansion](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L115)
...
## [VolumeSubpathEnvExpansion, subpath with absolute path](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L189)

- Added to conformance in release v1.19
- Defined in code as: [sig-node] Variable Expansion should fail substituting values in a volume subpath with absolute path [Conformance]
...
## [VolumeSubpathEnvExpansion, subpath with backticks](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L155)

- Added to conformance in release v1.19
- Defined in code as: [sig-node] Variable Expansion should fail substituting values in a volume subpath with backticks [Conformance]

Make sure a container's subpath can not be set using an expansion of environment variables when backticks are supplied.

## [VolumeSubpathEnvExpansion, subpath test writes](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L300)

- Added to conformance in release v1.19
- Defined in code as: [sig-node] Variable Expansion should succeed in writing subpaths in container [Conformance]
...
## [VolumeSubpathEnvExpansion, subpath ready from failed state](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/node/expansion.go#L228)

- Added to conformance in release v1.19
- Defined in code as: [sig-node] Variable Expansion should verify that a failing subpath expansion can be modified during the lifecycle of a container [Conformance] [Slow]

Verify that a failing subpath expansion can be modified during the lifecycle of a container.

## [CRUD operations for deviceclasses](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/dra/dra.go#L99)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] [DRA] CRUD Tests resource.k8s.io/v1 DeviceClass [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for resource.k8s.io/v1 DeviceClass.

## [CRUD operations for devicetaintrules](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/dra/dra.go#L127)

- Added to conformance in release v1.37
- Defined in code as: [sig-node] [DRA] CRUD Tests resource.k8s.io/v1 DeviceTaintRule [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for resource.k8s.io/v1 DeviceTaintRule.

## [CRUD operations for resourceclaims](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/dra/dra.go#L169)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] [DRA] CRUD Tests resource.k8s.io/v1 ResourceClaim [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for resource.k8s.io/v1 ResourceClaim.

## [CRUD operations for resourceclaimtemplates](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/dra/dra.go#L221)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] [DRA] CRUD Tests resource.k8s.io/v1 ResourceClaimTemplate [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for resource.k8s.io/v1 ResourceClaimTemplate.

## [CRUD operations for resoureslices](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/dra/dra.go#L258)

- Added to conformance in release v1.35
- Defined in code as: [sig-node] [DRA] CRUD Tests resource.k8s.io/v1 ResourceSlice [Conformance]

kube-apiserver must support create/update/list/patch/delete operations for resource.k8s.io/v1 ResourceSlice.

## [LimitRange, resources](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/limit_range.go#L65)
...
## [LimitRange, list, patch and delete a LimitRange by collection](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/limit_range.go#L256)
...
## [Scheduler, resource limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/predicates.go#L333)

- Added to conformance in release v1.9
- Defined in code as: [sig-scheduling] SchedulerPredicates validates resource limits of pods that are allowed to run [Conformance] [Serial]

Scheduling Pods MUST fail if the resource requests exceed Machine capacity.

## [Scheduler, node selector matching](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/predicates.go#L468)

- Added to conformance in release v1.9
- Defined in code as: [sig-scheduling] SchedulerPredicates validates that NodeSelector is respected if matching [Conformance] [Serial]
...
## [Scheduler, node selector not matching](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/predicates.go#L445)

- Added to conformance in release v1.9
- Defined in code as: [sig-scheduling] SchedulerPredicates validates that NodeSelector is respected if not matching [Conformance] [Serial]
...
## [Scheduling, HostPort and Protocol match, HostIPs different but one is default HostIP (0.0.0.0)](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/predicates.go#L706)

- Added to conformance in release v1.16
- Defined in code as: [sig-scheduling] SchedulerPredicates validates that there exists conflict between pods with same hostPort and protocol but one using 0.0.0.0 hostIP [Conformance] [Serial]
...
## [Pod preemption verification](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/preemption.go#L759)

- Added to conformance in release v1.19
- Defined in code as: [sig-scheduling] SchedulerPreemption PreemptionExecutionPath runs ReplicaSets to verify preemption running path [Conformance] [Serial]
...
## [Scheduler, Verify PriorityClass endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/preemption.go#L963)

- Added to conformance in release v1.20
- Defined in code as: [sig-scheduling] SchedulerPreemption PriorityClass endpoints verify PriorityClass endpoints can be operated with different HTTP methods [Conformance] [Serial]
...
## [Scheduler, Basic Preemption](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/preemption.go#L128)

- Added to conformance in release v1.19
- Defined in code as: [sig-scheduling] SchedulerPreemption validates basic preemption works [Conformance] [Serial]
...
## [Scheduler, Preemption for critical pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/preemption.go#L218)

- Added to conformance in release v1.19
- Defined in code as: [sig-scheduling] SchedulerPreemption validates lower priority pod preemption by critical pod [Conformance] [Serial]
...
## [Verify the DisruptionTarget condition is added to the preempted pod](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/scheduling/preemption.go#L482)

- Added to conformance in release v1.31
- Defined in code as: [sig-scheduling] SchedulerPreemption validates pod disruption condition is added to the preempted pod [Conformance] [Serial]
...
## [CSIDriver, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/csi_inline.go#L159)
...
## [CSIInlineVolumes should support Pods with inline volumes](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/csi_inline.go#L52)
...
## [CSINode, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/csi_node.go#L56)

- Added to conformance in release v1.32
- Defined in code as: [sig-storage] CSINodes CSI Conformance should run through the lifecycle of a csinode [Conformance]
...
## [CSIStorageCapacity API](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/csistoragecapacity.go#L52)
...
## [ConfigMap Volume, text data, binary data](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L190)

- Added to conformance in release v1.12
- Defined in code as: [sig-storage] ConfigMap binary data should be reflected in volume [Conformance] [NodeConformance]
...
## [ConfigMap Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L255)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap optional updates should be reflected in volume [Conformance] [NodeConformance]
...
## [ConfigMap Volume, without mapping](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L48)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume [Conformance] [NodeConformance]
...
## [ConfigMap Volume, without mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L82)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume as non-root [Conformance] [NodeConformance]

Create a ConfigMap, create a Pod that mounts a volume and populates the volume with data stored in the ConfigMap. Pod is run as a non-root user with uid=1000. The ConfigMap that is created MUST be accessible to read from the newly created Pod using the volume mount. The file on the volume MUST have file mode set to default value of 0x644.

## [ConfigMap Volume, without mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L58)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume with defaultMode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [ConfigMap Volume, with mapping](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L97)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume with mappings [Conformance] [NodeConformance]
...
## [ConfigMap Volume, with mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L107)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume with mappings and Item mode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [ConfigMap Volume, with mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L124)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable from pods in volume with mappings as non-root [Conformance] [NodeConformance]

Create a ConfigMap, create a Pod that mounts a volume and populates the volume with data stored in the ConfigMap. Files are mapped to a path in the volume. Pod is run as a non-root user with uid=1000. The ConfigMap that is created MUST be accessible to read from the newly created Pod using the volume mount. The file on the volume MUST have file mode set to default value of 0x644.

## [ConfigMap Volume, multiple volume maps](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L438)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap should be consumable in multiple volumes in the same pod [Conformance] [NodeConformance]
...
## [ConfigMap Volume, immutability](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L519)
...
## [ConfigMap Volume, update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/configmap_volume.go#L139)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] ConfigMap updates should be reflected in volume [Conformance] [NodeConformance]
...
## [DownwardAPI volume, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L215)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide container's cpu limit [Conformance] [NodeConformance]
...
## [DownwardAPI volume, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L243)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide container's cpu request [Conformance] [NodeConformance]
...
## [DownwardAPI volume, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L229)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide container's memory limit [Conformance] [NodeConformance]
...
## [DownwardAPI volume, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L257)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide container's memory request [Conformance] [NodeConformance]
...
## [DownwardAPI volume, CPU limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L271)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide node allocatable (cpu) as default cpu limit if the limit is not set [Conformance] [NodeConformance]
...
## [DownwardAPI volume, memory limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L283)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide node allocatable (memory) as default memory limit if the limit is not set [Conformance] [NodeConformance]
...
## [DownwardAPI volume, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L55)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should provide podname only [Conformance] [NodeConformance]
...
## [DownwardAPI volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L70)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should set DefaultMode on files [LinuxOnly] [Conformance] [NodeConformance]
...
## [DownwardAPI volume, file mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L96)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should set mode on item file [LinuxOnly] [Conformance] [NodeConformance]
...
## [DownwardAPI volume, update annotations](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L184)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should update annotations on modification [Conformance] [NodeConformance]
...
## [DownwardAPI volume, update label](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/downwardapi_volume.go#L152)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Downward API volume should update labels on modification [Conformance] [NodeConformance]
...
## [EmptyDir, Shared volumes between containers](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L232)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L202)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0644,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0644, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L132)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0644,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L212)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0666,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0666,, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L142)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0666,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L222)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0777,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0777, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L152)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (non-root,0777,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]

A Pod created with an 'emptyDir' Volume and 'medium' as 'Memory', the volume mode set to 0777. Volume is mounted into the container where container is run as a non-root user. The volume MUST have mode -rwxrwxrwx and mount type set to tmpfs and the contents MUST be readable. This test is marked LinuxOnly since Windows does not support setting specific file permissions, or running as UID / GID, or the medium = 'Memory'.

## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L172)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0644,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L102)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0644,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]

A Pod created with an 'emptyDir' Volume and 'medium' as 'Memory', the volume mode set to 0644. The volume MUST have mode -rw-r--r-- and mount type set to tmpfs and the contents MUST be readable. This test is marked LinuxOnly since Windows does not support setting specific file permissions, or running as UID / GID, or the medium = 'Memory'.

## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L182)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0666,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L112)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0666,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]

A Pod created with an 'emptyDir' Volume and 'medium' as 'Memory', the volume mode set to 0666. The volume MUST have mode -rw-rw-rw- and mount type set to tmpfs and the contents MUST be readable. This test is marked LinuxOnly since Windows does not support setting specific file permissions, or running as UID / GID, or the medium = 'Memory'.

## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L192)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0777,default) [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L122)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes should support (root,0777,tmpfs) [LinuxOnly] [Conformance] [NodeConformance]

A Pod created with an 'emptyDir' Volume and 'medium' as 'Memory', the volume mode set to 0777.  The volume MUST have mode set as -rwxrwxrwx and mount type set to tmpfs and the contents MUST be readable. This test is marked LinuxOnly since Windows does not support setting specific file permissions, or running as UID / GID, or the medium = 'Memory'.

## [EmptyDir, medium default, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L162)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes volume on default medium should have the correct mode [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir, medium memory, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/empty_dir.go#L92)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] EmptyDir volumes volume on tmpfs should have the correct mode [LinuxOnly] [Conformance] [NodeConformance]
...
## [EmptyDir Wrapper Volume, ConfigMap volumes, no race](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/empty_dir_wrapper.go#L190)

- Added to conformance in release v1.13
- Defined in code as: [sig-storage] EmptyDir wrapper volumes should not cause race condition when used for configmaps [Conformance] [Serial]
...
## [EmptyDir Wrapper Volume, Secret and ConfigMap volumes, no conflict](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/empty_dir_wrapper.go#L69)
...
## [PersistentVolumes(Claims), apply changes to a pv/pvc status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/persistent_volumes.go#L693)
...
## [PersistentVolumes(Claims), lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/persistent_volumes.go#L450)
...
## [Projected Volume, multiple projections](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_combined.go#L44)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected combined should project all components that make up the projection API [Projection] [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L189)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap optional updates should be reflected in volume [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L48)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L82)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume as non-root [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L58)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume with defaultMode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L97)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume with mappings [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L107)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume with mappings and Item mode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, mapped, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L124)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable from pods in volume with mappings as non-root [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L390)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap should be consumable in multiple volumes in the same pod [Conformance] [NodeConformance]
...
## [Projected Volume, ConfigMap, update](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_configmap.go#L139)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected configMap updates should be reflected in volume [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L215)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide container's cpu limit [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L243)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide container's cpu request [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L229)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide container's memory limit [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L257)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide container's memory request [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, CPU limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L271)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide node allocatable (cpu) as default cpu limit if the limit is not set [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, memory limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L283)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide node allocatable (memory) as default memory limit if the limit is not set [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L55)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should provide podname only [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L70)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should set DefaultMode on files [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L96)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should set mode on item file [LinuxOnly] [Conformance] [NodeConformance]

A Pod is created with a projected volume source for downwardAPI with pod name, cpu and memory limits and cpu and memory requests. The default mode for the volume mount is set to 0400. Pod MUST be able to read the pod name from the mounted DownwardAPIVolumeFiles and the volume mode must be -r--------. This test is marked LinuxOnly since Windows does not support setting specific file permissions.

## [Projected Volume, DownwardAPI, update annotation](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L184)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should update annotations on modification [Conformance] [NodeConformance]
...
## [Projected Volume, DownwardAPI, update labels](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_downwardapi.go#L152)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected downwardAPI should update labels on modification [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, create, update delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L226)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret optional updates should be reflected in volume [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L47)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable from pods in volume [Conformance] [NodeConformance]
...
## [Project Volume, Secrets, non-root, custom fsGroup](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L68)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable from pods in volume as non-root with defaultMode and fsGroup set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L57)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable from pods in volume with defaultMode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L84)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable from pods in volume with mappings [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L94)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable from pods in volume with mappings and Item Mode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Projected Volume, Secrets, mapped, multiple paths](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/projected_secret.go#L130)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Projected secret should be consumable in multiple volumes in a pod [Conformance] [NodeConformance]
...
## [Secrets Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L216)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets optional updates should be reflected in volume [Conformance] [NodeConformance]
...
## [Secrets Volume, volume mode default, secret with same name in different namespace](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L110)

- Added to conformance in release v1.12
- Defined in code as: [sig-storage] Secrets should be able to mount in a volume regardless of a different secret existing with same name in different namespace [Conformance] [NodeConformance]
...
## [Secrets Volume, default](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L48)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable from pods in volume [Conformance] [NodeConformance]
...
## [Secrets Volume, volume mode 0440, fsGroup 1001 and uid 1000](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L69)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable from pods in volume as non-root with defaultMode and fsGroup set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Secrets Volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L58)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable from pods in volume with defaultMode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Secrets Volume, mapping](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L85)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable from pods in volume with mappings [Conformance] [NodeConformance]
...
## [Secrets Volume, mapping, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L95)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable from pods in volume with mappings and Item Mode set [LinuxOnly] [Conformance] [NodeConformance]
...
## [Secrets Volume, mapping multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L136)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] Secrets should be consumable in multiple volumes in a pod [Conformance] [NodeConformance]
...
## [Secrets Volume, immutability](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/common/storage/secrets_volume.go#L397)
...
## [StorageClass, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/storageclass.go#L55)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/subpath.go#L69)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/subpath.go#L79)
...
## [SubPath: Reading content from a downwardAPI volume.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/subpath.go#L91)
...
## [SubPath: Reading content from a projected volume.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/subpath.go#L105)
...
## [SubPath: Reading content from a secret volume.](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/subpath.go#L59)
...
## [VolumeAttachment, apply changes to a volumeattachment status](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/volume_attachment.go#L184)

- Added to conformance in release v1.32
- Defined in code as: [sig-storage] VolumeAttachment Conformance should apply changes to a volumeattachment status [Conformance]
...
## [VolumeAttachment, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/volume_attachment.go#L61)
...
## [VolumeAttributesClass, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.37/test/e2e/storage/volumeattributesclass.go#L51)

- Added to conformance in release v1.35
- Defined in code as: [sig-storage] VolumeAttributesClass [FeatureGate:VolumeAttributesClass] should run through the lifecycle of a VolumeAttributesClass [Conformance]

Creating a VolumeAttributesClass MUST succeed. Reading the VolumeAttributesClass MUST succeed. Patching the VolumeAttributesClass MUST succeed with its new label found. Deleting the VolumeAttributesClass MUST succeed and it MUST be confirmed. Replacement VolumeAttributesClass MUST be created. Updating the VolumeAttributesClass MUST succeed with its new label found. Deleting the VolumeAttributesClass via deleteCollection MUST succeed and it MUST be confirmed.
