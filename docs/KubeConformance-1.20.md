# Kubernetes Conformance Test Suite -  1.20
...
## **List of Tests**
## [Pod Lifecycle, post start exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/lifecycle_hook.go#L87)
...
## [Pod Lifecycle, post start http hook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/lifecycle_hook.go#L119)
...
## [Pod Lifecycle, prestop exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/lifecycle_hook.go#L103)
...
## [Pod Lifecycle, prestop http hook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/lifecycle_hook.go#L137)
...
## [Container Runtime, TerminationMessage, from log output of succeeding container](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtime.go#L237)
...
## [Container Runtime, TerminationMessage, from file of succeeding container](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtime.go#L254)
...
## [Container Runtime, TerminationMessage, from container's log output of failing container](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtime.go#L220)
...
## [Container Runtime, TerminationMessagePath, non-root user and non-default path](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtime.go#L196)
...
## [Container Runtime, Restart Policy, Pod Phases](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtime.go#L49)
...
## [Docker containers, with arguments](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/docker_containers.go#L56)
...
## [Docker containers, with command](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/docker_containers.go#L70)
...
## [Docker containers, with command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/docker_containers.go#L84)
...
## [Docker containers, without command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/docker_containers.go#L36)
...
## [init-container-starts-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/init_container.go#L250)
...
## [init-container-starts-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/init_container.go#L174)
...
## [init-container-fails-stops-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/init_container.go#L451)
...
## [init-container-fails-stops-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/init_container.go#L327)
...
## [Kubelet, hostAliases](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet.go#L146)
...
## [Kubelet, log output, default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet.go#L49)
...
## [Kubelet, failed pod, delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet.go#L132)
...
## [Kubelet, failed pod, terminated reason](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet.go#L107)
...
## [Kubelet, pod with read only root file system](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet.go#L197)
...
## [Kubelet, managed etc hosts](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/kubelet_etc_hosts.go#L60)
...
## [lease API should be available](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/lease.go#L68)
...
## [Pods, ActiveDeadlineSeconds](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L404)
...
## [Pods, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L219)
...
## [Pods, update](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L350)
...
## [Pods, service environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L450)
...
## [Pods, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L845)
...
## [Pods, assigned hostip](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L197)
...
## [Pods, completes the lifecycle of a Pod and the PodStatus](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L894)

- Added to conformance in release v1.20
- Defined in code as: [k8s.io] Pods should run through the lifecycle of Pods and PodStatus [Conformance]
...
## [Pods, remote command execution over websocket](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L542)
...
## [Pods, logs from websockets](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/pods.go#L624)
...
## [Pod liveness probe, using http endpoint, failure](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L200)
...
## [Pod liveness probe, using local file, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L138)
...
## [Pod liveness probe, using tcp socket, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L170)
...
## [Pod liveness probe, using http endpoint, restart](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L155)
...
## [Pod liveness probe, using local file, restart](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L121)
...
## [Pod liveness probe, using http endpoint, multiple restarts (slow)](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L185)
...
## [Pod readiness probe, with initial delay](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L62)
...
## [Pod readiness probe, failure](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/container_probe.go#L96)
...
## [Security Context, runAsUser=65534](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/security_context.go#L83)
...
## [Security Context, privileged=false.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/security_context.go#L264)
...
## [Security Context, readOnlyRootFilesystem=false.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/security_context.go#L222)
...
## [Security Context, allowPrivilegeEscalation=false.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/security_context.go#L345)
...
## [Environment variables, expansion](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L41)
...
## [Environment variables, command argument expansion](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L89)
...
## [Environment variables, command expansion](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L70)
...
## [VolumeSubpathEnvExpansion, subpath expansion](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L109)
...
## [VolumeSubpathEnvExpansion, subpath with absolute path](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L183)
...
## [VolumeSubpathEnvExpansion, subpath with backticks](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L149)
...
## [VolumeSubpathEnvExpansion, subpath test writes](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L291)
...
## [VolumeSubpathEnvExpansion, subpath ready from failed state](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/expansion.go#L222)
...
## [Pod events, verify event from Scheduler and Kubelet](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/node/events.go#L44)
...
## [Pod Eviction, Toleration limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/node/taints.go#L417)
...
## [Taint, Pod Eviction on taint removal](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/node/taints.go#L287)
...
## [Pods, QOS](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/node/pods.go#L159)
...
## [Pods, prestop hook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/node/pre_stop.go#L166)
...
## [Admission webhook, list mutating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L652)
...
## [Admission webhook, list validating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L578)
...
## [Admission webhook, update mutating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L504)
...
## [Admission webhook, update validating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L409)
...
## [Admission webhook, deny attach](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L205)
...
## [Admission webhook, deny custom resource create and delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L217)
...
## [Admission webhook, deny create](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L193)
...
## [Admission webhook, deny custom resource definition](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L304)
...
## [Admission webhook, honor timeout](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L377)
...
## [Admission webhook, discovery document](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L113)
...
## [Admission webhook, ordered mutation](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L248)
...
## [Admission webhook, mutate custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L287)
...
## [Admission webhook, mutate custom resource with different stored version](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L319)
...
## [Admission webhook, mutate custom resource with pruning](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L337)
...
## [Admission webhook, mutation with defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L260)
...
## [Admission webhook, admission control not allowed on webhook configuration objects](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L273)
...
## [Admission webhook, fail closed](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/webhook.go#L235)
...
## [aggregator-supports-the-sample-apiserver](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/aggregator.go#L98)
...
## [Custom Resource Definition Conversion Webhook, convert mixed version list](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_conversion_webhook.go#L182)
...
## [Custom Resource Definition Conversion Webhook, conversion custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_conversion_webhook.go#L147)
...
## [Custom Resource Definition, watch](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_watch.go#L49)
...
## [Custom Resource Definition, create](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/custom_resource_definition.go#L56)
...
## [Custom Resource Definition, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/custom_resource_definition.go#L143)
...
## [Custom Resource Definition, list](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/custom_resource_definition.go#L83)
...
## [Custom Resource Definition, defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/custom_resource_definition.go#L267)
...
## [Custom Resource Definition, discovery](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/custom_resource_definition.go#L196)
...
## [Custom Resource OpenAPI Publish, stop serving version](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L430)
...
## [Custom Resource OpenAPI Publish, version rename](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L379)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields at root](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L182)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields in embedded object](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L224)
...
## [Custom Resource OpenAPI Publish, with validation schema](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L66)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields in object](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L141)
...
## [Custom Resource OpenAPI Publish, varying groups](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L264)
...
## [Custom Resource OpenAPI Publish, varying kinds](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L345)
...
## [Custom Resource OpenAPI Publish, varying versions](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/crd_publish_openapi.go#L297)
...
## [Discovery, confirm the PreferredVersion for each api group](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/discovery.go#L91)
...
## [Event, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/events.go#L132)
...
## [Event resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/events.go#L48)
...
## [Garbage Collector, delete deployment,  propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L506)
...
## [Garbage Collector, delete replication controller, propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L327)
...
## [Garbage Collector, delete replication controller, after owned pods](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L665)
...
## [Garbage Collector, dependency cycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L864)
...
## [Garbage Collector, multiple owners](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L750)
...
## [Garbage Collector, delete deployment, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L565)
...
## [Garbage Collector, delete replication controller, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/garbage_collector.go#L385)
...
## [namespace-deletion-removes-pods](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/namespace.go#L235)
...
## [namespace-deletion-removes-services](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/namespace.go#L243)
...
## [Namespace patching](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/namespace.go#L260)
...
## [ResourceQuota, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L857)
...
## [ResourceQuota, object count quota, configmap](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L297)
...
## [ResourceQuota, object count quota, pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L201)
...
## [ResourceQuota, object count quota, replicaSet](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L421)
...
## [ResourceQuota, object count quota, replicationController](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L365)
...
## [ResourceQuota, object count quota, secret](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L131)
...
## [ResourceQuota, object count quota, service](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L85)
...
## [ResourceQuota, object count quota, resourcequotas](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L60)
...
## [ResourceQuota, quota scope, BestEffort and NotBestEffort scope](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L776)
...
## [ResourceQuota, quota scope, Terminating and NotTerminating scope](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/resource_quota.go#L663)
...
## [Secrets, pod environment field](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets.go#L44)
...
## [Secrets, pod environment from source](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets.go#L93)
...
## [Secrets, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets.go#L138)
...
## [Secret patching](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets.go#L152)
...
## [API metadata HTTP return](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/table_conversion.go#L152)
...
## [watch-configmaps-closed-and-restarted](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/watch.go#L190)
...
## [watch-configmaps-from-resource-version](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/watch.go#L141)
...
## [watch-configmaps-with-multiple-watchers](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/watch.go#L55)
...
## [watch-configmaps-label-changed](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/watch.go#L256)
...
## [watch-consistency](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/watch.go#L333)
...
## [Confirm a server version](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apimachinery/server_version.go#L37)
...
## [DaemonSet-FailedPodCreation](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/daemon_set.go#L277)
...
## [DaemonSet-Rollback](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/daemon_set.go#L415)
...
## [DaemonSet-NodeSelection](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/daemon_set.go#L177)
...
## [DaemonSet-Creation](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/daemon_set.go#L149)
...
## [DaemonSet-RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/daemon_set.go#L357)
...
## [Deployment Recreate](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L107)
...
## [Deployment RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L99)
...
## [Deployment RevisionHistoryLimit](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L116)
...
## [Deployment Proportional Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L142)
...
## [Deployment Rollover](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L126)
...
## [Deployment, completes the lifecycle of a Deployment](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/deployment.go#L163)
...
## [Jobs, orphan pods, re-adoption](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/job.go#L181)
...
## [Jobs, active pods, graceful termination](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/job.go#L155)
...
## [Jobs, completion after task failure](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/job.go#L100)
...
## [Replica Set, adopt matching pods and release non matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/replica_set.go#L114)
...
## [Replica Set, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/replica_set.go#L94)
...
## [Replication Controller, adopt matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/rc.go#L89)
...
## [Replication Controller, release pods](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/rc.go#L98)
...
## [Replication Controller, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/rc.go#L64)
...
## [Replication Controller, check for issues like exceeding allocated quota](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/rc.go#L80)
...
## [Replication Controller, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/rc.go#L107)
...
## [StatefulSet, Burst Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L687)
...
## [StatefulSet, Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L577)
...
## [StatefulSet, Recreate Failed Pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L729)
...
## [StatefulSet resource Replica scaling](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L839)
...
## [StatefulSet, Rolling Update with Partition](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L307)
...
## [StatefulSet, Rolling Update](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/apps/statefulset.go#L296)
...
## [CertificateSigningRequest API](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/auth/certificates.go#L186)
...
## [Service account tokens auto mount optionally](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/auth/service_accounts.go#L282)
...
## [Service Account Tokens Must AutoMount](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/auth/service_accounts.go#L176)
...
## [TokenRequestProjection should mount a projected volume with token using TokenRequest API.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/auth/service_accounts.go#L427)
...
## [ServiceAccount lifecycle test](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/auth/service_accounts.go#L784)
...
## [Kubectl, guestbook application](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L367)
...
## [Kubectl, check version v1](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L777)
...
## [Kubectl, cluster info](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1070)
...
## [Kubectl, describe pod or rc](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1096)
...
## [Kubectl, diff Deployment](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L884)
...
## [Kubectl, create service, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1235)
...
## [Kubectl, label update](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1329)
...
## [Kubectl, logs](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1412)
...
## [Kubectl, patch to annotate](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1472)
...
## [Kubectl, replace](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1567)
...
## [Kubectl, run pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1533)
...
## [Kubectl, server-side dry-run Pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L915)
...
## [Kubectl, version](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1505)
...
## [Kubectl, proxy socket](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1632)
...
## [Kubectl, proxy port zero](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L1607)
...
## [Kubectl, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L312)
...
## [Kubectl, scale replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/kubectl/kubectl.go#L325)
...
## [New Event resource lifecycle, testing a list of events](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/instrumentation/events.go#L188)
...
## [New Event resource lifecycle, testing a single event](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/instrumentation/events.go#L95)
...
## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L114)
...
## [DNS, for ExternalName Services](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L330)
...
## [DNS, resolve the hostname](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L245)
...
## [DNS, resolve the subdomain](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L287)
...
## [DNS, services](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L134)
...
## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L47)
...
## [DNS, PQDN for services](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L190)
...
## [DNS, custom dnsConfig](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/dns.go#L408)
...
## [Ingress API](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/ingress.go#L917)
...
## [IngressClass API](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/ingressclass.go#L160)
...
## [Networking, intra pod http](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/networking.go#L80)
...
## [Networking, intra pod udp](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/networking.go#L91)
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/networking.go#L103)
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/networking.go#L120)
...
## [Proxy, logs service endpoint](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/proxy.go#L85)
...
## [Service endpoint latency, thresholds](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service_latency.go#L56)
...
## [Service, change type, ClusterIP to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L1711)
...
## [Service, change type, ExternalName to ClusterIP](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L1634)
...
## [Service, change type, ExternalName to NodePort](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L1673)
...
## [Service, change type, NodePort to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L1753)
...
## [Service, NodePort Service](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L1161)
...
## [Service, NodePort type, session affinity to None](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2482)
...
## [Service, ClusterIP type, session affinity to None](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2434)
...
## [Find Kubernetes Service in default Namespace](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2725)
...
## [Service, NodePort type, session affinity to ClientIP with timeout](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2466)
...
## [Service, ClusterIP type, session affinity to ClientIP with timeout](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2418)
...
## [Service, NodePort type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2449)
...
## [Service, ClusterIP type, session affinity to ClientIP](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2402)
...
## [Kubernetes Service](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L768)
...
## [Service, endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L778)
...
## [Service, endpoints with multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L831)
...
## [Endpoint resource lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/network/service.go#L2748)
...
## [ConfigMap, from environment field](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap.go#L42)
...
## [ConfigMap, from environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap.go#L90)
...
## [ConfigMap, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap.go#L135)
...
## [ConfigMap lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap.go#L166)
...
## [DownwardAPI, environment for CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downward_api.go#L164)
...
## [DownwardAPI, environment for default CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downward_api.go#L215)
...
## [DownwardAPI, environment for host ip](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downward_api.go#L88)
...
## [DownwardAPI, environment for Pod UID](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downward_api.go#L265)
...
## [DownwardAPI, environment for name, namespace and ip](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downward_api.go#L42)
...
## [PodTemplate, delete a collection](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/podtemplates.go#L118)
...
## [PodTemplate lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/podtemplates.go#L49)
...
## [RuntimeClass API](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/runtimeclass.go#L100)
...
## [LimitRange, resources](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/limit_range.go#L55)
...
## [Scheduler, resource limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/predicates.go#L324)
...
## [Scheduler, node selector matching](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/predicates.go#L457)
...
## [Scheduler, node selector not matching](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/predicates.go#L434)
...
## [Scheduling, HostPort and Protocol match, HostIPs different but one is default HostIP (0.0.0.0)](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/predicates.go#L761)
...
## [Scheduling, HostPort matching and HostIP and Protocol not-matching](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/predicates.go#L662)

- Added to conformance in release v1.16
- Defined in code as: [sig-scheduling] SchedulerPredicates [Serial] validates that there is no conflict between pods with same hostPort but different hostIP and protocol [Conformance]

Pods with the same HostPort value MUST be able to be scheduled to the same node if the HostIP or Protocol is different.

## [Pod preemption verification](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/preemption.go#L533)
...
## [Scheduler, Verify PriorityClass endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/preemption.go#L720)
...
## [Scheduler, Basic Preemption](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/preemption.go#L121)
...
## [Scheduler, Preemption for critical pod](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/scheduling/preemption.go#L209)
...
## [ConfigMap Volume, text data, binary data](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L172)
...
## [ConfigMap Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L236)
...
## [ConfigMap Volume, without mapping](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L44)
...
## [ConfigMap Volume, without mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L71)
...
## [ConfigMap Volume, without mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L54)
...
## [ConfigMap Volume, with mapping](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L86)
...
## [ConfigMap Volume, with mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L96)
...
## [ConfigMap Volume, with mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L106)
...
## [ConfigMap Volume, multiple volume maps](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L419)
...
## [ConfigMap Volume, update](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/configmap_volume.go#L121)
...
## [DownwardAPI volume, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L190)
...
## [DownwardAPI volume, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L218)
...
## [DownwardAPI volume, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L204)
...
## [DownwardAPI volume, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L232)
...
## [DownwardAPI volume, CPU limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L246)
...
## [DownwardAPI volume, memory limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L258)
...
## [DownwardAPI volume, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L50)
...
## [DownwardAPI volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L65)
...
## [DownwardAPI volume, file mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L81)
...
## [DownwardAPI volume, update annotations](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L159)
...
## [DownwardAPI volume, update label](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/downwardapi_volume.go#L127)
...
## [EmptyDir, Shared volumes between containers](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L226)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L196)
...
## [EmptyDir, medium memory, volume mode 0644, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L126)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L206)
...
## [EmptyDir, medium memory, volume mode 0666,, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L136)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L216)
...
## [EmptyDir, medium memory, volume mode 0777, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L146)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L166)
...
## [EmptyDir, medium memory, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L96)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L176)
...
## [EmptyDir, medium memory, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L106)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L186)
...
## [EmptyDir, medium memory, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L116)
...
## [EmptyDir, medium default, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L156)
...
## [EmptyDir, medium memory, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/empty_dir.go#L86)
...
## [EmptyDir Wrapper Volume, ConfigMap volumes, no race](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/empty_dir_wrapper.go#L187)
...
## [EmptyDir Wrapper Volume, Secret and ConfigMap volumes, no conflict](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/empty_dir_wrapper.go#L65)
...
## [Projected Volume, multiple projections](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_combined.go#L41)
...
## [Projected Volume, ConfigMap, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L171)
...
## [Projected Volume, ConfigMap, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L44)
...
## [Projected Volume, ConfigMap, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L71)
...
## [Projected Volume, ConfigMap, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L54)
...
## [Projected Volume, ConfigMap, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L86)
...
## [Projected Volume, ConfigMap, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L96)
...
## [Projected Volume, ConfigMap, mapped, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L106)
...
## [Projected Volume, ConfigMap, multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L372)
...
## [Projected Volume, ConfigMap, update](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_configmap.go#L121)
...
## [Projected Volume, DownwardAPI, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L190)
...
## [Projected Volume, DownwardAPI, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L218)
...
## [Projected Volume, DownwardAPI, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L204)
...
## [Projected Volume, DownwardAPI, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L232)
...
## [Projected Volume, DownwardAPI, CPU limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L246)
...
## [Projected Volume, DownwardAPI, memory limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L258)
...
## [Projected Volume, DownwardAPI, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L50)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L65)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L81)
...
## [Projected Volume, DownwardAPI, update annotation](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L159)
...
## [Projected Volume, DownwardAPI, update labels](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_downwardapi.go#L127)
...
## [Projected Volume, Secrets, create, update delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L212)
...
## [Projected Volume, Secrets, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L43)
...
## [Project Volume, Secrets, non-root, custom fsGroup](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L64)
...
## [Projected Volume, Secrets, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L53)
...
## [Projected Volume, Secrets, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L75)
...
## [Projected Volume, Secrets, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L85)
...
## [Projected Volume, Secrets, mapped, multiple paths](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/projected_secret.go#L116)
...
## [Secrets Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L202)
...
## [Secrets Volume, volume mode default, secret with same name in different namespace](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L96)
...
## [Secrets Volume, default](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L44)
...
## [Secrets Volume, volume mode 0440, fsGroup 1001 and uid 1000](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L65)
...
## [Secrets Volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L54)
...
## [Secrets Volume, mapping](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L76)
...
## [Secrets Volume, mapping, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L86)
...
## [Secrets Volume, mapping multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/common/secrets_volume.go#L122)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/subpath.go#L71)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/subpath.go#L83)
...
## [SubPath: Reading content from a downwardAPI volume.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/subpath.go#L97)
...
## [SubPath: Reading content from a projected volume.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/subpath.go#L113)
...
## [SubPath: Reading content from a secret volume.](https://github.com/kubernetes/kubernetes/tree/release-1.20/test/e2e/storage/subpath.go#L59)
