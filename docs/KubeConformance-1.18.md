# Kubernetes Conformance Test Suite -  1.18
...
## **List of Tests**
## [Pod Lifecycle, post start exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/lifecycle_hook.go#L99)
...
## [Pod Lifecycle, post start http hook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/lifecycle_hook.go#L131)
...
## [Pod Lifecycle, prestop exec hook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/lifecycle_hook.go#L115)
...
## [Pod Lifecycle, prestop http hook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/lifecycle_hook.go#L149)
...
## [](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/runtime.go#L236)
...
Name: Container Runtime, TerminationMessage, from log output of succeeding container Create a pod with an container. Container's output is recorded in log and container exits successfully without an error. When container is terminated, terminationMessage MUST have no content as container succeed. [LinuxOnly]: Cannot mount files in Windows Containers.

## [](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/runtime.go#L253)
...
Name: Container Runtime, TerminationMessage, from file of succeeding container Create a pod with an container. Container's output is recorded in a file and the container exits successfully without an error. When container is terminated, terminationMessage MUST match with the content from file. [LinuxOnly]: Cannot mount files in Windows Containers.

## [](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/runtime.go#L219)
...
Name: Container Runtime, TerminationMessage, from container's log output of failing container Create a pod with an container. Container's output is recorded in log and container exits with an error. When container is terminated, termination message MUST match the expected output recorded from container's log. [LinuxOnly]: Cannot mount files in Windows Containers.

## [](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/runtime.go#L195)
...
## [Docker containers, with arguments](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/docker_containers.go#L57)
...
## [Docker containers, with command](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/docker_containers.go#L73)
...
Note: when you override the entrypoint, the image's arguments (docker cmd) are ignored. Default command from the docker image entrypoint MUST NOT be used when Pod specifies the container command.  Command from Pod spec MUST override the command in the image.

## [Docker containers, with command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/docker_containers.go#L87)
...
## [Docker containers, without command and arguments](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/docker_containers.go#L38)
...
## [init-container-starts-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/init_container.go#L232)
...
## [init-container-starts-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/init_container.go#L165)
...
## [init-container-fails-stops-app-restartnever-pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/init_container.go#L417)
...
## [init-container-fails-stops-app-restartalways-pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/init_container.go#L302)
...
## [Kubelet, hostAliases](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet.go#L146)
...
## [Kubelet, log output, default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet.go#L49)
...
## [Kubelet, failed pod, delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet.go#L132)
...
## [Kubelet, failed pod, terminated reason](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet.go#L107)
...
## [Kubelet, pod with read only root file system](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet.go#L197)
...
## [Kubelet, managed etc hosts](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/kubelet_etc_hosts.go#L62)
...
## [lease API should be available](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/lease.go#L68)
...
## [Pods, ActiveDeadlineSeconds](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L416)
...
## [Pods, lifecycle](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L209)
...
## [Pods, update](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L362)
...
## [Pods, service environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L462)
...
## [Pods, assigned hostip](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L187)
...
## [Pods, remote command execution over websocket](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L554)
...
## [Pods, logs from websockets](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/pods.go#L636)
...
## [Pod liveness probe, using http endpoint, failure](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L199)
...
## [Pod liveness probe, using local file, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L138)
...
## [Pod liveness probe, using tcp socket, no restart](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L169)
...
## [Pod liveness probe, using http endpoint, restart](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L154)
...
## [Pod liveness probe, using local file, restart](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L122)
...
## [Pod liveness probe, using http endpoint, multiple restarts (slow)](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L184)
...
## [Pod readiness probe, with initial delay](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L63)
...
## [Pod readiness probe, failure](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/container_probe.go#L97)
...
## [Security Context, runAsUser=65534](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/security_context.go#L83)
...
## [Security Context, privileged=false.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/security_context.go#L264)
...
## [Security Context, readOnlyRootFilesystem=false.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/security_context.go#L222)
...
## [Security Context, allowPrivilegeEscalation=false.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/security_context.go#L345)
...
## [Environment variables, expansion](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/expansion.go#L46)
...
## [Environment variables, command argument expansion](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/expansion.go#L126)
...
## [Environment variables, command expansion](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/expansion.go#L91)
...
## [Pod events, verify event from Scheduler and Kubelet](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/node/events.go#L43)
...
## [Pod Eviction, Toleration limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/node/taints.go#L417)
...
## [Taint, Pod Eviction on taint removal](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/node/taints.go#L287)
...
## [Pods, QOS](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/node/pods.go#L166)
...
## [Pods, prestop hook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/node/pre_stop.go#L180)
...
## [Admission webhook, list mutating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L653)
...
## [Admission webhook, list validating webhooks](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L579)
...
## [Admission webhook, update mutating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L505)
...
## [Admission webhook, update validating webhook](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L410)
...
## [Admission webhook, deny attach](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L206)
...
## [Admission webhook, deny custom resource create and delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L218)
...
## [Admission webhook, deny create](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L194)
...
## [Admission webhook, deny custom resource definition](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L305)
...
## [Admission webhook, honor timeout](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L378)
...
## [Admission webhook, discovery document](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L114)
...
## [Admission webhook, ordered mutation](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L249)
...
## [Admission webhook, mutate custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L288)
...
## [Admission webhook, mutate custom resource with different stored version](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L320)
...
## [Admission webhook, mutate custom resource with pruning](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L338)
...
## [Admission webhook, mutation with defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L261)
...
## [Admission webhook, admission control not allowed on webhook configuration objects](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L274)
...
## [Admission webhook, fail closed](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/webhook.go#L236)
...
## [aggregator-supports-the-sample-apiserver](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/aggregator.go#L97)

- Added to conformance in release 
...
## [Custom Resource Definition Conversion Webhook, convert mixed version list](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_conversion_webhook.go#L182)
...
## [Custom Resource Definition Conversion Webhook, conversion custom resource](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_conversion_webhook.go#L147)
...
## [Custom Resource Definition, watch](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_watch.go#L49)
...
## [Custom Resource Definition, create](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/custom_resource_definition.go#L56)
...
## [Custom Resource Definition, status sub-resource](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/custom_resource_definition.go#L143)
...
## [Custom Resource Definition, list](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/custom_resource_definition.go#L83)
...
## [Custom Resource Definition, defaulting](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/custom_resource_definition.go#L267)
...
## [Custom Resource Definition, discovery](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/custom_resource_definition.go#L196)
...
## [Custom Resource OpenAPI Publish, stop serving version](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L429)
...
## [Custom Resource OpenAPI Publish, version rename](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L378)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields at root](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L181)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields in embedded object](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L223)
...
## [Custom Resource OpenAPI Publish, with validation schema](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L65)
...
## [Custom Resource OpenAPI Publish, with x-preserve-unknown-fields in object](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L140)
...
## [Custom Resource OpenAPI Publish, varying groups](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L263)
...
## [Custom Resource OpenAPI Publish, varying kinds](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L344)
...
## [Custom Resource OpenAPI Publish, varying versions](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/crd_publish_openapi.go#L296)
...
## [Garbage Collector, delete deployment,  propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L499)
...
## [Garbage Collector, delete replication controller, propagation policy background](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L326)
...
## [Garbage Collector, delete replication controller, after owned pods](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L642)
...
## [Garbage Collector, dependency cycle](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L838)

- Added to conformance in release v1.9
- Defined in code as: [sig-api-machinery] Garbage collector should not be blocked by dependency circle [Conformance]

TODO: should be an integration test Create three pods, patch them with Owner references such that pod1 has pod3, pod2 has pod1 and pod3 has pod2 as owner references respectively. Delete pod1 MUST delete all pods. The dependency cycle MUST not block the garbage collection.

## [Garbage Collector, multiple owners](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L727)
...
TODO: this should be an integration test Create a replication controller RC1, with maximum allocatable Pods between 10 and 100 replicas. Create second replication controller RC2 and set RC2 as owner for half of those replicas. Once RC1 is created and the all Pods are created, delete RC1 with deleteOptions.PropagationPolicy set to Foreground. Half of the Pods that has RC2 as owner MUST not be deleted but have a deletion timestamp. Deleting the Replication Controller MUST not delete Pods that are owned by multiple replication controllers.

## [Garbage Collector, delete deployment, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L558)
...
## [Garbage Collector, delete replication controller, propagation policy orphan](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/garbage_collector.go#L384)
...
## [namespace-deletion-removes-pods](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/namespace.go#L236)
...
## [namespace-deletion-removes-services](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/namespace.go#L243)
...
## [Namespace patching](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/namespace.go#L260)
...
## [ResourceQuota, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L857)
...
## [ResourceQuota, object count quota, configmap](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L297)
...
## [ResourceQuota, object count quota, pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L201)
...
## [ResourceQuota, object count quota, replicaSet](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L421)
...
## [ResourceQuota, object count quota, replicationController](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L365)
...
## [ResourceQuota, object count quota, secret](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L131)
...
## [ResourceQuota, object count quota, service](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L85)
...
## [ResourceQuota, object count quota, resourcequotas](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L60)
...
## [ResourceQuota, quota scope, BestEffort and NotBestEffort scope](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L776)
...
## [ResourceQuota, quota scope, Terminating and NotTerminating scope](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/resource_quota.go#L663)
...
## [Secrets, pod environment field](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets.go#L43)
...
## [Secrets, pod environment from source](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets.go#L92)
...
## [Secrets, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets.go#L137)
...
## [Secret patching](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets.go#L151)
...
## [API metadata HTTP return](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/table_conversion.go#L154)
...
## [watch-configmaps-closed-and-restarted](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/watch.go#L187)
...
## [watch-configmaps-from-resource-version](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/watch.go#L139)
...
## [watch-configmaps-with-multiple-watchers](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/watch.go#L54)
...
## [watch-configmaps-label-changed](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/watch.go#L252)
...
## [watch-consistency](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apimachinery/watch.go#L329)
...
## [DaemonSet-FailedPodCreation](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/daemon_set.go#L279)
...
## [DaemonSet-Rollback](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/daemon_set.go#L415)
...
## [DaemonSet-NodeSelection](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/daemon_set.go#L180)
...
## [DaemonSet-Creation](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/daemon_set.go#L153)
...
## [DaemonSet-RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/daemon_set.go#L358)
...
## [Deployment Recreate](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/deployment.go#L93)
...
## [Deployment RollingUpdate](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/deployment.go#L86)
...
## [Deployment RevisionHistoryLimit](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/deployment.go#L101)
...
## [Deployment Proportional Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/deployment.go#L125)
...
## [Deployment Rollover](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/deployment.go#L110)
...
## [Jobs, orphan pods, re-adoption](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/job.go#L180)
...
## [Jobs, active pods, graceful termination](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/job.go#L154)
...
## [Jobs, completion after task failure](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/job.go#L99)
...
## [Replica Set, adopt matching pods and release non matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/replica_set.go#L114)
...
## [Replica Set, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/replica_set.go#L94)
...
## [Replication Controller, adopt matching pods](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/rc.go#L74)
...
## [Replication Controller, release pods](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/rc.go#L83)
...
## [Replication Controller, run basic image](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/rc.go#L49)
...
## [Replication Controller, check for issues like exceeding allocated quota](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/rc.go#L65)
...
## [StatefulSet, Burst Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L657)
...
## [StatefulSet, Scaling](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L573)
...
## [StatefulSet, Recreate Failed Pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L699)
...
## [StatefulSet resource Replica scaling](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L792)
...
## [StatefulSet, Rolling Update with Partition](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L303)
...
## [StatefulSet, Rolling Update](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/apps/statefulset.go#L292)
...
## [Service account tokens auto mount optionally](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/auth/service_accounts.go#L279)
...
## [Service Account Tokens Must AutoMount](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/auth/service_accounts.go#L173)
...
## [Kubectl, guestbook application](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L331)
...
## [Kubectl, check version v1](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L722)
...
## [Kubectl, cluster info](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L958)
...
## [Kubectl, describe pod or rc](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L984)
...
## [Kubectl, create service, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1125)
...
## [Kubectl, label update](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1222)
...
## [Kubectl, logs](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1309)
...
## [Kubectl, patch to annotate](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1369)
...
## [Kubectl, replace](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1468)
...
## [Kubectl, run pod](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1432)
...
## [Kubectl, version](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1403)
...
## [Kubectl, proxy socket](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1533)
...
## [Kubectl, proxy port zero](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L1508)

- Added to conformance in release v1.9
- Defined in code as: [sig-cli] Kubectl client Proxy server should support proxy with --port 0  [Conformance]

TODO: test proxy options (static, prefix, etc) Start a proxy server on port zero by running 'kubectl proxy' with --port=0. Call the proxy server by requesting api versions from unix socket. The proxy server MUST provide at least one version string.

## [Kubectl, replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L280)
...
## [Kubectl, scale replication controller](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/kubectl/kubectl.go#L293)
...
## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L113)
...
## [DNS, for ExternalName Services](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L329)
...
## [DNS, resolve the hostname](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L244)
...
## [DNS, resolve the subdomain](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L286)
...
## [DNS, services](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L133)
...
## [DNS, cluster](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L46)
...
## [DNS, PQDN for services](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L189)
...
## [DNS, custom dnsConfig](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/dns.go#L407)
...
## [Networking, intra pod http](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/networking.go#L40)
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/networking.go#L67)
...
## [Networking, intra pod http, from node](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/networking.go#L81)
...
## [Proxy, logs endpoint](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/proxy.go#L78)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Proxy version v1 should proxy logs on node using proxy subresource  [Conformance]

Select any node in the cluster to invoke /proxy/nodes/<nodeip>//logs endpoint. This endpoint MUST be reachable.

## [Proxy, logs port endpoint](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/proxy.go#L71)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Proxy version v1 should proxy logs on node with explicit kubelet port using proxy subresource  [Conformance]

Select any node in the cluster to invoke /proxy/nodes/<nodeip>:10250/logs endpoint. This endpoint MUST be reachable.

## [Proxy, logs service endpoint](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/proxy.go#L87)

- Added to conformance in release v1.9
- Defined in code as: [sig-network] Proxy version v1 should proxy through a service and a pod  [Conformance]

using the porter image to serve content, access the content (of multiple pods?) from multiple (endpoints/services?) Select any node in the cluster to invoke  /logs endpoint  using the /nodes/proxy subresource from the kubelet port. This endpoint MUST be reachable.

## [Service endpoint latency, thresholds](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service_latency.go#L56)
...
## [Service, change type, ClusterIP to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L1686)
...
## [Service, change type, ExternalName to ClusterIP](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L1609)
...
## [Service, change type, ExternalName to NodePort](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L1648)
...
## [Service, change type, NodePort to ExternalName](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L1726)
...
## [Service, NodePort Service](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L1140)
...
## [Find Kubernetes Service in default Namespace](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L2668)
...
## [Kubernetes Service](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L721)
...
## [Service, endpoints](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L731)
...
## [Service, endpoints with multiple ports](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/network/service.go#L784)
...
## [ConfigMap, from environment field](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap.go#L42)
...
## [ConfigMap, from environment variables](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap.go#L90)
...
## [ConfigMap, with empty-key](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap.go#L135)
...
## [DownwardAPI, environment for CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downward_api.go#L164)
...
## [DownwardAPI, environment for default CPU and memory limits and requests](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downward_api.go#L215)
...
## [DownwardAPI, environment for host ip](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downward_api.go#L88)
...
## [DownwardAPI, environment for Pod UID](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downward_api.go#L265)
...
## [DownwardAPI, environment for name, namespace and ip](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downward_api.go#L42)
...
## [LimitRange, resources](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/scheduling/limit_range.go#L55)
...
## [Scheduler, resource limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/scheduling/predicates.go#L326)
...
## [Scheduler, node selector not matching](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/scheduling/predicates.go#L436)
...
Test Nodes does not have any label, hence it should be impossible to schedule Pod with nonempty Selector set. Create a Pod with a NodeSelector set to a value that does not match a node in the cluster. Since there are no nodes matching the criteria the Pod MUST not be scheduled.

## [Scheduling, HostPort and Protocol match, HostIPs different but one is default HostIP (0.0.0.0)](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/scheduling/predicates.go#L697)
...
## [Scheduling, HostPort matching and HostIP and Protocol not-matching](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/scheduling/predicates.go#L664)
...
## [ConfigMap Volume, text data, binary data](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L204)
...
## [ConfigMap Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L300)
...
## [ConfigMap Volume, without mapping](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L44)
...
## [ConfigMap Volume, without mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L71)
...
## [ConfigMap Volume, without mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L54)
...
## [ConfigMap Volume, with mapping](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L86)
...
## [ConfigMap Volume, with mapping, volume mode set](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L96)
...
## [ConfigMap Volume, with mapping, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L106)
...
## [ConfigMap Volume, multiple volume maps](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L483)
...
## [ConfigMap Volume, update](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/configmap_volume.go#L121)
...
## [DownwardAPI volume, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L194)
...
## [DownwardAPI volume, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L222)
...
## [DownwardAPI volume, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L208)
...
## [DownwardAPI volume, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L236)
...
## [DownwardAPI volume, CPU limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L250)
...
## [DownwardAPI volume, memory limit, default node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L262)
...
## [DownwardAPI volume, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L51)
...
## [DownwardAPI volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L66)
...
## [DownwardAPI volume, file mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L82)
...
## [DownwardAPI volume, update annotations](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L160)
...
## [DownwardAPI volume, update label](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/downwardapi_volume.go#L128)
...
## [EmptyDir, Shared volumes between containers](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L223)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L193)
...
## [EmptyDir, medium memory, volume mode 0644, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L123)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L203)
...
## [EmptyDir, medium memory, volume mode 0666,, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L133)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L213)
...
## [EmptyDir, medium memory, volume mode 0777, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L143)
...
## [EmptyDir, medium default, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L163)
...
## [EmptyDir, medium memory, volume mode 0644](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L93)
...
## [EmptyDir, medium default, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L173)
...
## [EmptyDir, medium memory, volume mode 0666](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L103)
...
## [EmptyDir, medium default, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L183)
...
## [EmptyDir, medium memory, volume mode 0777](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L113)
...
## [EmptyDir, medium default, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L153)
...
## [EmptyDir, medium memory, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/empty_dir.go#L83)
...
## [EmptyDir Wrapper Volume, ConfigMap volumes, no race](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/empty_dir_wrapper.go#L187)
...
## [EmptyDir Wrapper Volume, Secret and ConfigMap volumes, no conflict](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/empty_dir_wrapper.go#L65)
...
## [Host path, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/host_path.go#L49)

- Added to conformance in release v1.9
- Defined in code as: [sig-storage] HostPath should give a volume the correct mode [LinuxOnly] [NodeConformance] [Conformance]

Create a Pod with host volume mounted. The volume mounted MUST be a directory with permissions mode -rwxrwxrwx and that is has the sticky bit (mode flag t) set. This test is marked LinuxOnly since Windows does not support setting the sticky bit (mode flag t).

## [Projected Volume, multiple projections](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_combined.go#L41)
...
Test multiple projections A Pod is created with a projected volume source for secrets, configMap and downwardAPI with pod name, cpu and memory limits and cpu and memory requests. Pod MUST be able to read the secrets, configMap values and the cpu and memory limits as well as cpu and memory requests from the mounted DownwardAPIVolumeFiles.

## [Projected Volume, ConfigMap, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L209)
...
## [Projected Volume, ConfigMap, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L44)
...
## [Projected Volume, ConfigMap, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L71)
...
## [Projected Volume, ConfigMap, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L54)
...
## [Projected Volume, ConfigMap, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L86)
...
## [Projected Volume, ConfigMap, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L96)
...
## [Projected Volume, ConfigMap, mapped, non-root user](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L106)
...
## [Projected Volume, ConfigMap, multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L410)
...
## [Projected Volume, ConfigMap, update](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_configmap.go#L121)
...
## [Projected Volume, DownwardAPI, CPU limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L194)
...
## [Projected Volume, DownwardAPI, CPU request](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L222)
...
## [Projected Volume, DownwardAPI, memory limits](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L208)
...
## [Projected Volume, DownwardAPI, memory request](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L236)
...
## [Projected Volume, DownwardAPI, CPU limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L250)
...
## [Projected Volume, DownwardAPI, memory limit, node allocatable](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L262)
...
## [Projected Volume, DownwardAPI, pod name](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L51)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L66)
...
## [Projected Volume, DownwardAPI, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L82)
...
## [Projected Volume, DownwardAPI, update annotation](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L160)
...
## [Projected Volume, DownwardAPI, update labels](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_downwardapi.go#L128)
...
## [Projected Volume, Secrets, create, update delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L211)
...
## [Projected Volume, Secrets, volume mode default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L43)
...
## [Project Volume, Secrets, non-root, custom fsGroup](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L64)
...
## [Projected Volume, Secrets, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L53)
...
## [Projected Volume, Secrets, mapped](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L75)
...
## [Projected Volume, Secrets, mapped, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L85)
...
## [Projected Volume, Secrets, mapped, multiple paths](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/projected_secret.go#L116)
...
## [Secrets Volume, create, update and delete](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L201)
...
## [Secrets Volume, volume mode default, secret with same name in different namespace](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L96)
...
## [Secrets Volume, default](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L44)
...
## [Secrets Volume, volume mode 0440, fsGroup 1001 and uid 1000](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L65)
...
## [Secrets Volume, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L54)
...
## [Secrets Volume, mapping](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L76)
...
## [Secrets Volume, mapping, volume mode 0400](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L86)
...
## [Secrets Volume, mapping multiple volume paths](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/common/secrets_volume.go#L122)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/subpath.go#L72)
...
## [SubPath: Reading content from a configmap volume.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/subpath.go#L84)
...
## [SubPath: Reading content from a downwardAPI volume.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/subpath.go#L98)
...
## [SubPath: Reading content from a projected volume.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/subpath.go#L114)
...
## [SubPath: Reading content from a secret volume.](https://github.com/kubernetes/kubernetes/tree/release-1.18/test/e2e/storage/subpath.go#L60)
