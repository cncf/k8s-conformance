...
$ doctl kubernetes cluster create --version 1.29.9-do.1 do-sonobuoy-1299 --node-pool "name=conformance;size=s-4vcpu-8gb;count=3" --wait
```
...
Download [Sonobuoy 0.57.2](https://github.com/vmware-tanzu/sonobuoy/releases/tag/v0.57.2) tarball for your machine and unpack it:
