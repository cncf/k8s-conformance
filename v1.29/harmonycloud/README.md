...
First Install Harmonycloud Container Platform v3.3.1. Installation packages can be downloaded at  [here](http://harmonycloud.cn/products/rongqiyun/), the kubernetes version is v1.29.0.
