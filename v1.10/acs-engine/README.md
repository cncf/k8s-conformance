...
curl -L -o acs-engine-darwin.zip https://github.com/Azure/acs-engine/releases/download/v0.20.2/acs-engine-v0.20.2-darwin-amd64.zip

# Get the Kubernetes 1.10 install json

curl -o kubernetes1.10.json https://raw.githubusercontent.com/Azure/acs-engine/master/examples/kubernetes-releases/kubernetes1.10.json
...
$ acs-engine deploy --subscription-id $SUBID \
    ...
    --auto-suffix --api-model kubernetes1.10.json 
