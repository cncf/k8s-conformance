...
Install Weave GitOps Enterprise according to the [Weave GitOps Enterprise](https://docs.gitops.weave.works/docs/enterprise/upgrading).
...
Example template
   ...
   apiVersion: capi.weave.works/v1alpha1
    ...
    params:
        ...
        options: ["v1.19.13", "v1.20.9", "v1.21.2"]
