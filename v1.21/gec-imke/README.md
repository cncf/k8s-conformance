...
Please email sales@german-edge-cloud.io and ask for a new account credentials for Optimist and IMKE to be used by Cloud Native Computing Foundation (CNCF) Conformance tests for v1.21/innovo-imke
...
3. Create a new cluster in the project and select kubernetes version 1.21.0
