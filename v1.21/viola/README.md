...
-   **cluster docker images list**
    - coredns-v1.8.0.tar          
    - kube-controller-manager-v1.21.9.tar  
    ...
    - pause-3.4.1.tar
    - flannel-v0.13.0.tar         
    - kube-proxy-v1.21.9.tar               
    - nfs-client-provisioner.tar
    - kube-apiserver-v1.21.9.tar  
    - kube-scheduler-v1.21.9.tar           
...
#----------------------------------------------------------------------------------------------------------------------------
   - name: (5/10) Install k8s ---> [All k8s server]
     ...
     ansible.builtin.shell: |
             ...
             sudo dpkg -i /home/ubuntu/k8s-deb/v1.21.9/*.deb
     register: command_output
   - debug:
       var: command_output.stdout_lines
#----------------------------------------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------------------------------------------
   - name: (7-1/10) Init kubeadm in k8s-master
     ...
     vars:
       ...
       ansible_become_pass: *****
     ansible.builtin.shell: |
            kubeadm init --control-plane-endpoint "{{ mainIp }}" --upload-certs --pod-network-cidr=10.244.0.0/16 --kubernetes-version=1.21.9 --image-repository docker_registry_ip/docker_registry_directory > /home/ubuntu/init-k8s.txt
            mkdir /root/.kube
...
cicd-up-k8s-master    Ready    control-plane,master   230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
cicd-up-k8s-master2   Ready    control-plane,master   230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
cicd-up-k8s-master3   Ready    control-plane,master   230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
cicd-up-k8s-worker1   Ready    <none>                 230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
cicd-up-k8s-worker2   Ready    <none>                 230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
cicd-up-k8s-worker3   Ready    <none>                 230d   v1.21.9   XXX.XXX.XX.XX    <none>        Ubuntu 18.04.4 LTS   4.15.0-91-generic   docker://20.10.14
```
#