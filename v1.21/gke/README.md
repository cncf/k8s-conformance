...
#
# At time of test (2021-07-12), the rapid channel was at 1.20 by default,
# so we specify the specific cluster version of 1.21.1-gke.2200
#

gcloud --project $PROJECT_ID container clusters create $CLUSTER_NAME \
  --release-channel=rapid \
  --cluster-version=1.21.1-gke.2200 \
  --enable-ip-alias \
