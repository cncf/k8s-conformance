...
- Required components for the host
  - opentofu
    ```
    wget https://github.com/opentofu/opentofu/releases/download/v1.6.2/tofu_1.6.2_<arch>.rpm
    rpm -ivh tofu_1.6.2_<arch>.rpm
    ```
  - kubectl (Optional)
- directory(/etc/nkd)
    ```
