...
## Managed Kubernetes (based on Kubernetes v1.33)
...
$ sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e   complete   passed       1   Passed:419, Failed:  0, Remaining:  0
...
```sh
$ sonobuoy retrieve
202510130000_sonobuoy_2b474c98-ea91-4272-ab70-18f5bec5c921.tar.gz
```