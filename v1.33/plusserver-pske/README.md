...
## plusserver Kubernetes Engine (PSKE)  (base on Kubernetes v1.33.9)
...
- Select the 1.33.9 version of Kubernetes
...
```sh
$ sonobuoy retrieve
202604071557_sonobuoy_619f8cfa-65e1-446d-a844-364ec1a3c424.tar.gz
```
