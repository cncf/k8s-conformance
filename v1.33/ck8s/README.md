...
Follow the instructions at https://documentation.ubuntu.com/canonical-kubernetes/release-1.33/snap/tutorial/add-remove-nodes/ to install Canonical Kubernetes on two machines.
