...
Official documentation: https://docs.kubermatic.com/kubeone/v1.11/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.33
clusters, KubeOne v1.11.0 or newer is required.
...
[terraform-config]: https://github.com/kubermatic/kubeone/tree/release/v1.11/examples/terraform
[terraform-install]: https://learn.hashicorp.com/tutorials/terraform/install-cli
[kubeone-terraform]: https://docs.kubermatic.com/kubeone/v1.11/guides/using-terraform-configs/
[kubeone-ssh]: https://docs.kubermatic.com/kubeone/v1.11/guides/ssh/
