...
curl -L -s -f -O https://github.com/Azure/aks-engine/releases/download/v0.36.2/aks-engine-v0.36.2-linux-amd64.tar.gz

# Get the Kubernetes json file

curl -o kubernetes1.14.json https://raw.githubusercontent.com/Azure/aks-engine/master/examples/azurestack/kubernetes-azurestack-azure-ad.json

# Open the Kubernetes json file and update orchestratorRelease value to 1.14
...
$ curl -L -o sonobuoy_0.14.0_linux_amd64.tar.gz \
    https://github.com/heptio/sonobuoy/releases/download/v0.14.0/sonobuoy_0.14.0_linux_amd64.tar.gz

# untar the tarball.
$ sudo tar -xvf sonobuoy_0.14.0_linux_amd64.tar.gz
