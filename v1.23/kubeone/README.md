...
Official documentation: https://docs.kubermatic.com/kubeone/v1.4/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.23
clusters, KubeOne v1.4.0 or newer is required.
...
[terraform-config]: https://github.com/kubermatic/kubeone/tree/release/v1.4/examples/terraform
[terraform-install]: https://learn.hashicorp.com/tutorials/terraform/install-cli
[kubeone-terraform]: https://docs.kubermatic.com/kubeone/v1.4/guides/using_terraform_configs/
[kubeone-ssh]: https://docs.kubermatic.com/kubeone/v1.4/guides/ssh/
