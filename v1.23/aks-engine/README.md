...
```console
curl -L -o aks-engine-darwin.tar.gz https://github.com/Azure/aks-engine/releases/download/v0.69.0/aks-engine-v0.69.0-darwin-amd64.tar.gz
```

Download the Kubernetes 1.23 install cluster definition.

```console
curl -o kubernetes1.23.json https://raw.githubusercontent.com/Azure/aks-engine/master/examples/kubernetes-releases/kubernetes1.23.json
```
...
$ aks-engine deploy --subscription-id $SUBID \
    ...
    --auto-suffix --api-model kubernetes1.23.json
```
