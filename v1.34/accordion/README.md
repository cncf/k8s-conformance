...
master_ip: 10.60.200.70

master_mode "no"
```
```
$ vi etc/hosts
10.60.200.70 acc-master
10.60.200.71 acc-node1
10.60.200.72 acc-node2
```
...
acc-master   Ready    control-plane   2d16h   v1.34.2   10.60.200.70   <none>        Rocky Linux 9.5 (Blue Onyx)   5.14.0-503.14.1.el9_5.x86_64   containerd://1.7.26
acc-node1    Ready    worker          2d16h   v1.34.2   10.60.200.71   <none>        Rocky Linux 9.5 (Blue Onyx)   5.14.0-503.14.1.el9_5.x86_64   containerd://1.7.26
acc-node2    Ready    worker          2d16h   v1.34.2   10.60.200.72   <none>        Rocky Linux 9.5 (Blue Onyx)   5.14.0-503.14.1.el9_5.x86_64   containerd://1.7.26
```
