...
ibmcloud oc cluster create vpc-gen2 --name conformance --version 4.21_openshift --zone ZONE --flavor FLAVOR --vpc-id ID --subnet-id ID --cos-instance INSTANCE --workers COUNT
```
...
cluster creation UI, select version 4.21.13 and choose the appropriate infrastructure,
