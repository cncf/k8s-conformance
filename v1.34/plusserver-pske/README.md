...
## plusserver Kubernetes Engine (PSKE)  (base on Kubernetes v1.34.7)
...
- Select the 1.34.7 version of Kubernetes
...
```sh
$ sonobuoy retrieve
202605180558_sonobuoy_53cfd1f9-7777-450f-aa60-d901b464c558.tar.gz
```
