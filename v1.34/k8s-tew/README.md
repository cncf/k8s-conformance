...
```shell
./k8s-tew initialize
./k8s-tew configure --version-kube-apiserver=registry.k8s.io/kube-apiserver:v1.34.0
./k8s-tew configure --version-kube-controller-manager=registry.k8s.io/kube-controller-manager:v1.34.0
./k8s-tew configure --version-kube-proxy=registry.k8s.io/kube-proxy:v1.34.0
./k8s-tew configure --version-kube-scheduler=registry.k8s.io/kube-scheduler:v1.34.0
...
./sonobuoy run --mode=certified-conformance --plugin-env=e2e.E2E_EXTRA_ARGS="--ginkgo.v" --kubernetes-version=v1.34.0
```
