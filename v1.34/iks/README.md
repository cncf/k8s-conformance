...
ibmcloud ks cluster create vpc-gen2 --name conformance --version 1.34 --zone ZONE --flavor FLAVOR --vpc-id ID --subnet-id ID --workers COUNT
```
...
UI, select version 1.34.10 and choose the appropriate infrastructure, location, and
