...
Official documentation: https://docs.kubermatic.com/kubeone/v1.12/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.34
clusters, KubeOne v1.12.0 or newer is required.
...
[terraform-config]: https://github.com/kubermatic/kubeone/tree/release/v1.12/examples/terraform
[terraform-install]: https://learn.hashicorp.com/tutorials/terraform/install-cli
[kubeone-terraform]: https://docs.kubermatic.com/kubeone/v1.12/guides/using-terraform-configs/
[kubeone-ssh]: https://docs.kubermatic.com/kubeone/v1.12/guides/ssh/
