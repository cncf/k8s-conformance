...
```
$ sonobuoy run --mode=certified-conformance --wait   --plugin-env e2e.E2E_EXTRA_ARGS="--non-blocking-taints=node-role.kubernetes.io/master,node-role.kubernetes.io/control-plane"
```
