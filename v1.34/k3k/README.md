...
2. Create k3k cluster following the steps below
 ...
 3. Run Conformance test
    sonobuoy run --mode=certified-conformance --plugin=e2e --plugin-env=e2e.E2E_EXTRA_ARGS="--ginkgo.v" --kubernetes-version=v1.34.3 --kubeconfig=/home/ec2-user/virtual-k3kcluster-kubeconfig.yaml
