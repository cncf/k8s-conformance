...
BUILD: wrcp_dev_build_2025-12-15_19-01-09
...
* Bootstrap system on controller-0
  ...
  * Verify and/or configure IP connectivity.
    ...
    External connectivity is required to run the Ansible bootstrap playbook. The boot image will DHCP out all interfaces so the server may have obtained an IP address and have external IP connectivity if a DHCP server is present in your environment. Verify this using the ip addr and ping 8.8.8.8 commands.
