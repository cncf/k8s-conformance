...
name=Beta rhocp-4.21 RPMs for RHEL 9
...
[microshift-preview]
name=Beta microshift-4.21 RPMs for RHEL 9
baseurl=https://mirror.openshift.com/pub/openshift-v4/x86_64/microshift/ocp/4.21.0-rc.2/el9/os/
enabled=1
gpgcheck=0
skip_if_unavailable=0
EOF
...
#TODO might not need most of these now.
...
```
git clone https://github.com/openshift/microshift.git --branch release-4.21
cd ./microshift/
