...
- The cluster Kubernetes version need choose v1.34.x
...
- Push image to custom image repo ```sonobuoy images  --kubernetes-version v1.34.0 push --e2e-repo-config custom-repo-config.yaml --custom-registry cr-helm2-cn-beijing.cr.volces.com/sonobuoy```
...
--kube-conformance-image=cr-helm2-cn-beijing.cr.volces.com/sonobuoy/conformance:v1.34.0
```
