...
## Create Aruba Managed Kubernetes cluster (based on Kubernetes v1.34.1)
...
6. Kubernetes version
    - Select which **version of Kubernetes** you want to use (1.34 in this case)
    - Click on **Next**
7. Configuration
...
6a0d5ddc0c0acb2ddfd45f7f--md-certpool-9pfjq-c6m55   Ready    <none>   3h34m   v1.34.1
6a0d5ddc0c0acb2ddfd45f7f--md-certpool-9pfjq-rcpll   Ready    <none>   3h34m   v1.34.1
