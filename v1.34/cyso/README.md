...
## Managed Kubernetes (based on Kubernetes v1.34)
...
See our [documentation](https://cyso.cloud/docs/enterprise-managed-kubernetes/how-to-access-my-emk-cluster/) about accessing the cluster or visit the Cyso Cloud dashboard and download a Time-Limited kubeconfig.
...
$ sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e   complete   passed       1   Passed:424, Failed:  0, Remaining:  0
...
```sh
$ sonobuoy retrieve
202605220000_sonobuoy_5e41fc92-6c7b-43ef-a529-974a4af2ab72.tar.gz
```