...
## Create Aruba Managed Kubernetes cluster (based on Kubernetes v1.35.3)
...
6. Kubernetes version
    - Select which **version of Kubernetes** you want to use (1.34444 in this case)
    - Click on **Next**
7. Configuration
...
6aa401f76520798027658b6b--md-pool1-4wlvz-pp4jf   Ready    <none>   3h51m   v1.35.3
6aa401f76520798027658b6b--md-pool1-4wlvz-qgdcx   Ready    <none>   3h51m   v1.35.3
6aa401f76520798027658b6b--md-pool1-4wlvz-xd8dv   Ready    <none>   3h51m   v1.35.3
...
$ export KUBECONFIG=/root/sonobuoy/kubeconfig-diretto.yaml

##
# Download a binary release of the CLI
$ wget https://github.com/vmware-tanzu/sonobuoy/releases/download/v0.57.5/sonobuoy_0.57.5_linux_386.tar.gz
$ tar -xvf sonobuoy_0.57.5_linux_386.tar.gz
$ chmod a+x sonobuoy
