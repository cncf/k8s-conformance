...
[Quick Start Guide]: https://docs.k0sproject.io/v1.35.1+k0s.0/install/
...
Download the k0s v1.35.1+k0s.0 binary from the [GitHub Releases Page] and push
it to all the machines you wish to connect to the cluster.

[GitHub Releases Page]: https://github.com/k0sproject/k0s/releases/tag/v1.35.1+k0s.0
