...
## plusserver Kubernetes Engine (PSKE)  (base on Kubernetes v1.35.5)
...
- Select the 1.35.5 version of Kubernetes
...
$ sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e   complete   passed       1   Passed:  0, Failed:  0, Remaining:441
...
```sh
$ sonobuoy retrieve
202608260704_sonobuoy_666e20ed-1283-428e-bbc4-4152a1787ce3.tar.gz
```
