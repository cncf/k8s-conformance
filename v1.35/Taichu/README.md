# Conformance tests for TaiChu v1.13.0
...
8. create directory ```v1.35/Taichu``` and copy  ```e2e.log, junit_01.xml``` to here.
```
mkdir -p ./v1.35/Taichu
cp ./sonobuoy/plugins/e2e/results/global/* ./v1.35/Taichu
```

9. Generate ```PRODUCT.yaml```
```
cat << EOF > ./v1.35/TaiChu/PRODUCT.yaml
