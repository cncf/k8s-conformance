...
Tue Sep 01 15:19:39 2026 [I] [CLS]: Starting cluster provisioning
Tue Sep 01 15:19:39 2026 [I] [CLS]: Cluster 1 changed state from PENDING to PROVISIONING
Tue Sep 01 15:19:39 2026 [I] [EVT]: Cluster 1 provision started
Tue Sep 01 15:19:39 2026 [I] [GRP]: ControlPlane (ID=2) changed state from PENDING to BOOTSTRAPPING
Tue Sep 01 15:19:39 2026 [I] [SVM]: Creating Seed VM for ControlPlane provisioning
Tue Sep 01 15:19:39 2026 [I] [SVM]: Seed VM (ID=4) deployed successfully
Tue Sep 01 15:19:39 2026 [I] [EVT]: ControlPlane (ID=2) bootstrap successfully
```
...
root@opennebula-server:~# oneks list cluster
  ...
  1  oneadmin oneadmin cert-cluster   RUNNING       09/01 15:19:39
```
...
root@opennebula-server:~# onevm list
  ID USER     GROUP    NAME                                                 STAT  CPU     MEM HOST             TIME
   8 oneadmin oneadmin nodegroup-general-medium-813d141c97da-r6ds5-vqkdk    runn    4      8G 172.20.0.3   0d 16h04
   7 oneadmin oneadmin controlplane-general-standalone-5c3e7a5d3666-lslqr   runn    2      4G 172.20.0.3   0d 16h11
   6 oneadmin oneadmin vr-controlplane-general-standalone-5c3e7a5d3666-cp-0 runn    1    512M 172.20.0.3   0d 16h11
```
...
controlplane-general-standalone-5c3e7a5d3666-lslqr   Ready    control-plane,etcd   16h   v1.35.0+rke2r1   192.168.200.102   192.168.200.102   Ubuntu 22.04.5 LTS   5.15.0-140-generic   containerd://2.1.5-k3s1
nodegroup-general-medium-813d141c97da-r6ds5-vqkdk    Ready    <none>               16h   v1.35.0+rke2r1   192.168.200.103   192.168.200.103   Ubuntu 22.04.5 LTS   5.15.0-140-generic   containerd://2.1.5-k3s1
```
