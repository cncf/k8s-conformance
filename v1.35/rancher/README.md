# Conformance tests for Rancher 2.x Provisioned RKE2
...
docker run -d --restart=unless-stopped \
  -p 80:80 -p 443:443 \
  --privileged \
  rancher/rancher:v2.14.0-alpha7
```

## Run RKE2 Kubernetes Cluster
...
* Ensure that k8s version `v1.35.1+rke2r1` is selected
