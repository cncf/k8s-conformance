...
$ tar -zxvf sonobuoy_0.57.5_linux_amd64.tar.gz
```
...
Configuring an ACP cluster mainly involves several parts, including Postinstallation Configuration, Clusters Configuration, Hosted Control Planes, Nodes, etcd, Backup and Restore, Storage, Registry Administration, and Platform Settings. Please refer to the Configure section on the https://docs.alauda.io website for detailed configuration methods.
