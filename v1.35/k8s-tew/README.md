...
```shell
wget https://raw.githubusercontent.com/darxkies/k8s-tew/2.4.13/Vagrantfile
...
```shell
wget https://github.com/darxkies/k8s-tew/releases/download/2.4.13/k8s-tew
chmod u+x k8s-tew
```
...
```shell
./k8s-tew initialize
./k8s-tew configure --version-k8s=v1.35.0
./k8s-tew configure --version-kube-apiserver=registry.k8s.io/kube-apiserver:v1.35.0
./k8s-tew configure --version-kube-controller-manager=registry.k8s.io/kube-controller-manager:v1.35.0
./k8s-tew configure --version-kube-proxy=registry.k8s.io/kube-proxy:v1.35.0
./k8s-tew configure --version-kube-scheduler=registry.k8s.io/kube-scheduler:v1.35.0
...
./sonobuoy run --mode=certified-conformance --plugin-env=e2e.E2E_EXTRA_ARGS="--ginkgo.v" --kubernetes-version=v1.35.0
```
