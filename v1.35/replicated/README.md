...
```
sudo apt-get install -y containerd=2.2.1-0ubuntu1~24.04.2 conntrack
```
...
Install Kubernetes v1.35 with kURL:
```
curl -sSL https://kurl.sh/kurl-conformance-1-35-x | sudo bash
```
...
Untar the results:
```
$ tar xzvf 202605190327_sonobuoy_7eaa5dec-edd2-4577-8a09-5a56e8a7ab33.tar.gz
```
