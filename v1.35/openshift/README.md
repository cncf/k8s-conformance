...
1. Download and extract `openshift-install` and `oc` binaries from https://mirror.openshift.com/pub/openshift-v4/clients/ocp-dev-preview/4.22.0-ec.4/.
...
```
hydrophone --conformance --conformance-image registry.k8s.io/conformance:v1.35.2 --extra-args="--allowed-not-ready-nodes=3"
```
