...
$ az group create --name conformance-v1350 --location uksouth # create the resource group

$ az aks create -g conformance-v1350 -n aks-conformance -k 1.35.0 --node-count 2 --generate-ssh-keys # create a two node AKS cluster

$ az aks get-credentials --resource-group conformance-v1350 --name aks-conformance # get the AKS cluster Kubernetes credentials for use with kubectl
```
