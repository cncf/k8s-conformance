...
Official documentation: https://docs.kubermatic.com/kubeone/v1.13/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.35
clusters, KubeOne v1.13.0 or newer is required.
