...
Get the default subnet, then create a Kubernetes 1.35 cluster with a public control-plane endpoint:
...
The submitted results were generated with [Sonobuoy v0.57.5](https://github.com/vmware-tanzu/sonobuoy/releases/tag/v0.57.5) against Kubernetes v1.35. Install that Sonobuoy release, then run:
