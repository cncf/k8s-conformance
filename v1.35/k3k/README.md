...
2. Create k3k cluster following the steps below
    ...
    # Install k3kcli
    wget https://github.com/rancher/k3k/releases/download/v1.0.2-rc1/k3kcli-linux-amd64
 ...
 3. Run Conformance test
    sonobuoy run --mode=certified-conformance --plugin=e2e --plugin-env=e2e.E2E_EXTRA_ARGS="--ginkgo.v" --kubernetes-version=v1.35.0 --kubeconfig=/home/ec2-user/virtual-k3kcluster-kubeconfig.yaml
