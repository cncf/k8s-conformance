...
Note: Use the wget command to directly download the package to your appliance server. i.e. `wget https://www.hpe.com/support/hpesc/path/to/package/morpheus-appliance_x.x.x-1.amd64.deb`. The package must be 8.1.1 or higher to perform the test on the 1.35 HA set-up (3 Masters and 3 Workers)
...
#### Use the Kubernetes Cluster to deploy a 1.35 HA Configuration on the Cloud created
...
8. Populate the following:
    ...
    **LAYOUT**: `HKS Kubernetes 1.35 HA Cluster on Ubuntu 24.04`
