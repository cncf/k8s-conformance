...
1. Use the following example command for a quick start to create a 3 control plane nodes and 3 worker nodes on a local system 
    ~~~
       ocne cluster start --version 1.33 --control-plane-nodes 3 --worker-nodes 3
       export KUBECONFIG=$(ocne cluster show)
       kubectl get nodes
       NAME                   STATUS   ROLES           AGE    VERSION
       ocne-control-plane-1   Ready    control-plane   118m   v1.35.5+1.el8
       ocne-control-plane-2   Ready    control-plane   117m   v1.35.5+1.el8
       ocne-control-plane-3   Ready    control-plane   117m   v1.35.5+1.el8
       ocne-worker-1          Ready    <none>          116m   v1.35.5+1.el8
       ocne-worker-2          Ready    <none>          116m   v1.35.5+1.el8
       ocne-worker-3          Ready    <none>          116m   v1.35.5+1.el8
    ~~~
...
2. Obtain sonobuoy
    ...
    Begin test
    ~~~
       Sonobuoy Version: v0.57.4
       MinimumKubeVersion: 1.17.0
       MaximumKubeVersion: 1.99.99
       GitSHA: 
       GoVersion: go1.25.9
       Platform: linux/amd64
       API Version:  v1.35.5+1.el8
