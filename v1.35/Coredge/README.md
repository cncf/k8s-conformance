...
```bash
./master-installer.sh "v1.35.1" "<master-node-ip>"
```
...
```
sonobuoy run --plugin-env=e2e.E2E_EXTRA_ARGS="--non-blocking-taints=node-role.kubernetes.io/control-plane --ginkgo.v" --mode=certified-conformance --kubernetes-version="v1.35.1"
```
...
```
sonobuoy retrieve
202602170728_sonobuoy_6bf86ecd-485c-4fbb-b3d7-878fcad6a206.tar.gz
```

Untar the results:
```
tar xvf 202602170728_sonobuoy_6bf86ecd-485c-4fbb-b3d7-878fcad6a206.tar.gz
```
