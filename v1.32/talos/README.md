...
**NOTE**: These steps are a reproduction of our QEMU docs at https://www.talos.dev/docs/v1.9/local-platforms/qemu.
...
```bash
curl https://github.com/siderolabs/talos/releases/download/v1.9.0/talosctl-linux-amd64 -L -o talosctl
