...
You will need to deploy a cluster of 1 or more nodes. Mirantis recommends using [mkectl](https://github.com/MirantisContainers/mke/) to ease the provisioning and installation of an MKE 4.1.0 clusters.
