...
2. Download binary from https://public.shturval.tech/stc-2.10.0, rename to `stc` and make executable. 
3. Prepare infrastructure as described in https://docs.shturval.tech/2.10/platform/install/requirements/.
4. Follow installation process as descibed in https://docs.shturval.tech/2.10/platform/install/easystart/. In generic case it is enought to execute following command and answer number of questions.
