...
1. Download `openshift-install` and `oc` binaries from https://mirror.openshift.com/pub/openshift-v4/clients/ocp-dev-preview/4.19.0-ec.2.
...
2. Follow the [test instructions](https://github.com/cncf/k8s-conformance/blob/master/instructions.md#hydrophone)
   to run the conformance tests. OpenShift cluster disables [scheduling on control plane nodes](https://docs.openshift.com/container-platform/4.17/nodes/nodes/nodes-nodes-managing.html#nodes-nodes-working-master-schedulable_nodes-nodes-managing)
