...
Define a Typhoon Kubernetes v1.32.x cluster in a Terraform workspace. Pick any OS + platform combination marked [stable](https://github.com/poseidon/typhoon/blob/v1.32.0/README.md#modules) at the v1.32 release.
...
yavin-controller-0.c.example-com.internal Ready  <none>  6m  v1.32.0
yavin-worker-jrbf.c.example-com.internal  Ready  <none>  5m  v1.32.0
yavin-worker-mzdm.c.example-com.internal  Ready  <none>  5m  v1.32.0
```
