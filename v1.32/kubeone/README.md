...
Official documentation: https://docs.kubermatic.com/kubeone/v1.10/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.32
clusters, KubeOne v1.10.0 or newer is required.
...
[terraform-config]: https://github.com/kubermatic/kubeone/tree/release/v1.9/examples/terraform
[terraform-install]: https://learn.hashicorp.com/tutorials/terraform/install-cli
[kubeone-terraform]: https://docs.kubermatic.com/kubeone/v1.9/guides/using-terraform-configs/
[kubeone-ssh]: https://docs.kubermatic.com/kubeone/v1.9/guides/ssh/
