...
## Create Aruba Managed Kubernetes cluster (based on Kubernetes v1.26.9)
...
6. Kubernetes version
    - Select which **version of Kubernetes** you want to use (1.26 in this case)
    - Click on **Next**
7. Configuration
...
6565d5f49154290e45c1c6d3--osmt-np01-mj6rn   Ready    <none>   14d   v1.26.9   10.10.10.95    <none>        Ubuntu 22.04.3 LTS   5.15.0-87-generic   containerd://1.7.6
6565d5f49154290e45c1c6d3--osmt-np01-x74g6   Ready    <none>   14d   v1.26.9   10.10.10.171   <none>        Ubuntu 22.04.3 LTS   5.15.0-87-generic   containerd://1.7.6
```
