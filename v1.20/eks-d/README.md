...
wget -qO ./kops "https://github.com/kubernetes/kops/releases/download/v1.20.1/kops-${os_arch}"
chmod +x ./kops
```
...
CNI_VERSION=v0.8.7
METRICS_SERVER_VERSION=v0.4.3
AWS_AUTH_VERSION=v0.5.2
...
export CNI_ASSET_HASH_STRING=sha256:87901b18d44454484d00e86486da9262de5b851a15473e0314e116bdc2efcbda
...
./kops create secret --name tlhowe.people.aws.dev sshpublickey admin -i ~/.ssh/id_rsa.pub
...
## Run Sonobuoy e2e
```
./sonobuoy run --mode=certified-conformance --wait --kube-conformance-image k8s.gcr.io/conformance:v1.20.4
