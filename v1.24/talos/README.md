...
**NOTE**: These steps are a reproduction of our QEMU docs at https://www.talos.dev/docs/v1.1/local-platforms/qemu.
...
For example version `v1.1.0`:

```bash
curl https://github.com/siderolabs/talos/releases/download/v1.1.0/vmlinuz-amd64 -L -o _out/vmlinuz-amd64
curl https://github.com/siderolabs/talos/releases/download/v1.1.0/initramfs-amd64.xz -L -o _out/initramfs-amd64.xz
```
