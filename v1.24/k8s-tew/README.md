...
```shell
wget https://raw.githubusercontent.com/darxkies/k8s-tew/2.4.10/Vagrantfile
...
```shell
wget https://github.com/darxkies/k8s-tew/releases/download/2.4.10/k8s-tew
chmod u+x k8s-tew
```
...
tar xzfv sonobuoy_0.56.4_linux_amd64.tar.gz
