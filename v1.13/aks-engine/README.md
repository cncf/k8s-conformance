...
# Get the Kubernetes 1.13 install json

curl -o kubernetes1.13.json https://github.com/Azure/aks-engine/blob/master/examples/kubernetes-releases/kubernetes1.13.json
...
$ aks-engine deploy --subscription-id $SUBID \
    ...
    --auto-suffix --api-model kubernetes1.13.json 
