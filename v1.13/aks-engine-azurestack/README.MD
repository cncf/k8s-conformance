...
curl -o kubernetes1.13.json https://raw.githubusercontent.com/Azure/aks-engine/master/examples/azurestack/kubernetes-azurestack-azure-ad.json

# Open the Kubernetes json file and update orchestratorRelease value to 1.13
