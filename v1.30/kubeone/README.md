...
Official documentation: https://docs.kubermatic.com/kubeone/v1.9/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.30
clusters, KubeOne v1.9.0 or newer is required.
