...
ibmcloud oc cluster create vpc-gen2 --name conformance --version 4.17_openshift --zone ZONE --flavor FLAVOR --vpc-id ID --subnet-id ID --cos-instance INSTANCE --workers COUNT
```
...
cluster creation UI, select version 4.17.18 and choose the appropriate infrastructure,
