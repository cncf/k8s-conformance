...
```bash
eksctl create cluster --version=1.25 \
  --name=sample-cluster-1-25 \
...
if [[ "$(uname)" == "Darwin" ]]
then
  SONOBUOY=https://github.com/vmware-tanzu/sonobuoy/releases/download/v0.56.15/sonobuoy_0.56.15_darwin_amd64.tar.gz
else
  SONOBUOY=https://github.com/vmware-tanzu/sonobuoy/releases/download/v0.56.15/sonobuoy_0.56.15_linux_386.tar.gz
fi
...
--sonobuoy-image=sonobuoy/sonobuoy:v0.56.15
````
