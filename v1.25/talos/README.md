...
**NOTE**: These steps are a reproduction of our QEMU docs at https://www.talos.dev/docs/v1.2/local-platforms/qemu.
...
```bash
curl https://github.com/siderolabs/talos/releases/download/v1.2.0/vmlinuz-amd64 -L -o _out/vmlinuz-amd64
curl https://github.com/siderolabs/talos/releases/download/v1.2.0/initramfs-amd64.xz -L -o _out/initramfs-amd64.xz
```
