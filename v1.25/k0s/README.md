...
Download the k0s v1.24.3+k0s.0 binary from [releases](https://github.com/k0sproject/k0s/releases/v1.24.3+k0s.0) and push it to all the nodes you wish to connect to the cluster.
...
$ sonobuoy run --mode=certified-conformance --kube-conformance-image-version=v1.24.3
```
