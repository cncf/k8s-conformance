...
$ az group create --name conformance-v1360-20260521 --location uksouth # create the resource group

$ az aks create -g conformance-v1360-20260521 -n aks-conformance-v1360 -k 1.36 --node-count 2 --generate-ssh-keys # create a two node AKS cluster

$ az aks get-credentials --resource-group conformance-v1360-20260521 --name aks-conformance-v1360 # get the AKS cluster Kubernetes credentials for use with kubectl
```
...
```console
$ sonobuoy run --mode=certified-conformance --kubernetes-version=v1.36.0
