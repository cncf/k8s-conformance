...
Official documentation: https://docs.kubermatic.com/kubeone/v1.14/
...
[GitHub Releases][kubeone-releases]. In order to manage Kubernetes v1.36
clusters, KubeOne v1.14.0 or newer is required.
...
[terraform-config]: https://github.com/kubermatic/kubeone/tree/release/v1.14/examples/terraform
[terraform-install]: https://learn.hashicorp.com/tutorials/terraform/install-cli
[kubeone-terraform]: https://docs.kubermatic.com/kubeone/v1.14/guides/using-terraform-configs/
[kubeone-ssh]: https://docs.kubermatic.com/kubeone/v1.14/guides/ssh/
