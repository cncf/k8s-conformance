...
ibmcloud ks cluster create vpc-gen2 --name conformance --version 1.36 --zone ZONE --flavor FLAVOR --vpc-id ID --subnet-id ID --workers COUNT
```
...
UI, select version 1.36.2 and choose the appropriate infrastructure, location, and
