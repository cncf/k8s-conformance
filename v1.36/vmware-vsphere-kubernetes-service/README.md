...
spec:
  ...
  topology:
    ...
    class: builtin-generic-v3.7.0
    #kubernetes version of the cluster 
    version: v1.36.1---vmware.2-vkr.1
...
* Monitor the provisioning of the cluster.
  ...
  vks-cluster-ns       vks-conformance   builtin-generic-v3.7.0   Provisioned   13m   v1.36.1+vmware.2-vkr.1
  ```
