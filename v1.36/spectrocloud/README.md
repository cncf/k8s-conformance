...
3. Deploy the cluster
   ...
   - For _Cluster name_ specify k8s1362 and choose your _Cloud Account_ created above for AWS. Click Next (cluster names need to be proper FQDN)
   - Click on _Add Cluster Profile_
   - Select pre-defined cluster profile _cncf_v1_36, click _Confirm_
...
4. Wait for cluster status to reach running state
...
```
$ curl <sonobuoy_0.57.5_linux_amd64.tar.gz> -o sonobuoy_0.57.5_linux_amd64.tar.gz
$ tar zxvf sonobuoy_0.57.5_linx_amd64.tar.gz
```
