...
civo k3s create test-cluster -v 1.36.0-k3s1 --wait
...
sonobuoy run \
        ...
        --plugin e2e \
        --plugin-env=e2e.E2E_EXTRA_ARGS="--non-blocking-taints=node-role.kubernetes.io/controller --ginkgo.flake-attempts=10 --ginkgo.v"
