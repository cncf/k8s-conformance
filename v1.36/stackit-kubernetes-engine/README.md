...
Follow this guide on how to create a STACKIT Kubernetes Engine cluster (https://docs.stackit.cloud/products/runtime/kubernetes-engine/getting-started/create-cluster/)
...
[Tutorials Overview](https://docs.stackit.cloud/products/runtime/kubernetes-engine/).
...
shoot--d0df460fd5--cl-bcjiib8g-pool-e56774tagx-z1-5f867-7kfgt   Ready    <none>   6h34m   v1.36.2   10.250.1.73   <none>        Flatcar Container Linux by Kinvolk 4593.2.2 (Oklo)   6.12.91-flatcar   containerd://2.1.5
shoot--d0df460fd5--cl-bcjiib8g-pool-e56774tagx-z1-5f867-wvz4n   Ready    <none>   6h34m   v1.36.2   10.250.2.55   <none>        Flatcar Container Linux by Kinvolk 4593.2.2 (Oklo)   6.12.91-flatcar   containerd://2.1.5
```
