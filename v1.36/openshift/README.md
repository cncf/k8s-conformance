...
1. Download and extract `openshift-install` and `oc` binaries from https://mirror.openshift.com/pub/openshift-v5/clients/ocp-dev-preview/5.0.0-ec.5/.
...
```
hydrophone --conformance --conformance-image registry.k8s.io/conformance:v1.36.2 --extra-args="--allowed-not-ready-nodes=3"
```
