...
Install Kubernetes v1.36 with kURL on the first node:
```
curl -sSL https://kurl.sh/kurl-conformance-osprey-1-36 | sudo bash
```
...
tar -xvf sonobuoy_0.57.5_linux_amd64.tar.gz
```
...
./sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e    running                1   Passed:  0, Failed:  0, Remaining:446
...
./sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e   complete   passed       1   Passed:  0, Failed:  0, Remaining:446
...
```
./sonobuoy retrieve
202608092014_sonobuoy_2e6240c4-1eb1-4142-99da-5f1c3e9193ca.tar.gz
```

Untar the results:
```
tar xzvf 202608092014_sonobuoy_2e6240c4-1eb1-4142-99da-5f1c3e9193ca.tar.gz
```
