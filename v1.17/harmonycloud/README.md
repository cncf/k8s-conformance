...
First Install Harmonycloud Container Platform v2.6.0. Installation packages can be downloaded at  [here](http://harmonycloud.cn/products/rongqiyun/), the kubernetes version is v1.17.2.
...
```
$ tar -xzvf sonobuoy_0.17.2_linux_amd64 .tar.gz
$ mv sonobuoy /usr/bin/
```
