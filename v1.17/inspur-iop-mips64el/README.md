# Inspur Open Platform for MIPS

## Prerequisites

- Linux Host OS (Kylin 4.0.2, GNU/Linux 4.4.58, mips64el)
- User SSH Key (~/.ssh/id_rsa & ~/.ssh/id_rsa.pub)
- Product installation package (includes images like hyperkube-mips64el:v1.16.2 and the deployment scripts,etc.)
