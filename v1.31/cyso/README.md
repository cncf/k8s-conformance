...
## Managed Kubernetes (based on Kubernetes v1.31)
...
Go to the "EMK" tab and select your cluster, view "access" to copy or download your temporary kubeconfig.
...
$ sonobuoy status
         PLUGIN     STATUS   RESULT   COUNT                                PROGRESS
            e2e   complete   passed       1   Passed:404, Failed:  0, Remaining:  0
...
```sh
$ sonobuoy retrieve
202503260000_sonobuoy_2b474c98-ea91-4272-ab70-18f5bec5c921.tar.gz
```